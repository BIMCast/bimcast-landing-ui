...
//    #endif
    {
        return com.apps.bimcast.bimcast.RootActivity();
    }

    // - - - - - - - - - - - - - - - - - - - - - - - -

    public interface LifecycleListener extends com.apps.bimcast.ActivityState.AndroidLifecycleListener {}

    public static void subscribeToLifecycleChange(LifecycleListener listener)
	{
        com.apps.bimcast.bimcast activity = (com.apps.bimcast.bimcast)getRootActivity();
