...
public class TextInput
{
    ...
    public static void AddEditorActionListener127(final Object _this, final Object handle)
    {
        ((android.widget.TextView)handle).setOnEditorActionListener(new android.widget.TextView.OnEditorActionListener() {
        				public boolean onEditorAction(android.widget.TextView v, int actionId, android.view.KeyEvent ke) { 
        					return ExternedBlockHost.callUno_Fuse_Controls_Native_Android_TextInput_OnEditorAction128(_this,actionId);
        				}
        			});
    }
    
    public static void AddTextChangedListener129(final Object _this, final Object handle)
    {
        ((android.widget.TextView)handle).addTextChangedListener(new android.text.TextWatcher() {
        				...
        				public void onTextChanged(java.lang.CharSequence cs, int start, int before, int count) {
        					...
        					ExternedBlockHost.callUno_Fuse_Controls_Native_Android_TextInput_OnTextChanged130(_this,str);
        				}
        			});
    }
    
    public static void ClearFocus131(final Object handle)
    {
        android.widget.TextView t = (android.widget.TextView)handle;
        			t.clearFocus();
    }
    
    public static Object Create1132()
    {
        return new android.widget.EditText(com.apps.bimcast.bimcast.GetRootActivity());
    }
    
    public static boolean HasFocus133(final Object viewHandle)
    {
        return ((android.view.View)viewHandle).hasFocus();
    }
    
    public static void RequestFocus134(final Object viewHandle)
    {
        ((android.view.View)viewHandle).requestFocus();
    }
    
    public static void SetCursorDrawableColor135(final Object _this, final Object handle,final int color)
    {
    ...
    public static void SetImeOptions136(final Object handle,final int value)
    {
        ((android.widget.TextView)handle).setImeOptions(value);
    }
    
    public static void SetInputType137(final Object handle,final int value)
    {
    ...
    public static void SetPlaceholderColor138(final Object handle,final int value)
    {
        ((android.widget.TextView)handle).setHintTextColor(value);
    }
    
    public static void SetPlaceholderText139(final Object handle,final String value)
    {
        ((android.widget.TextView)handle).setHint(value);
    }
    
    public static void SetSelectionColor140(final Object handle,final int color)
    {
