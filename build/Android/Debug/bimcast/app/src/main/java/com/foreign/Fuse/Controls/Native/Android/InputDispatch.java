...
public class InputDispatch
{
    ...
    public static void ClearOnTouchListener58(final Object viewHandle)
    {
        ((android.view.View)viewHandle).setOnTouchListener(null);
    }
    
    public static Object CreateTouchListener59()
    {
        return new android.view.View.OnTouchListener() {
        					public boolean onTouch(android.view.View view, android.view.MotionEvent e) {
        						return ExternedBlockHost.callUno_Fuse_Controls_Native_Android_InputDispatch_OnTouch60(view,e,UnoHelper.GetUnoObjectRef(view),UnoHelper.GetUnoObjectRef(e));
        					}
        				};
    }
    
    public static void SetOnTouchListener61(final Object viewHandle,final Object listenerHandle)
    {
