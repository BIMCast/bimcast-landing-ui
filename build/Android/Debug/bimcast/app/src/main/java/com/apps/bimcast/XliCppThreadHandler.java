...
public class XliCppThreadHandler extends Handler {
	...
	private void handleRepeating(Message msg)
	{
		if (msg.arg1 == xliCallbackIndex) {
            com.apps.bimcast.ActivityNativeEntryPoints.cppTimerCallback(msg.arg1); // {TODO} this should own callback
			...
			com.apps.bimcast.ActivityNativeEntryPoints.cppTimerCallback(msg.arg1);
