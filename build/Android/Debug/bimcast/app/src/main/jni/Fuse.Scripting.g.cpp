...
static void Marshal_build(uType* type)
{
    ...
    ::STRINGS[45] = uString::Const("Expected number was ");
    ::STRINGS[6] = uString::Const("C:\\ProgramData\\Uno\\Packages\\FuseCore\\0.35.12\\Scripting\\$.uno");
    ::STRINGS[46] = uString::Const("#");
    ::STRINGS[47] = uString::Const(" to float4");
    ::STRINGS[48] = uString::Const("Unable to parse selector value: ");
    ::STRINGS[49] = uString::Const("%");
    ::STRINGS[50] = uString::Const("px");
    ::STRINGS[51] = uString::Const("pt");
    ::STRINGS[52] = uString::Const("Unable to parse size value: ");
    ::STRINGS[53] = uString::Const("Unable to parse size vector: ");
    ::STRINGS[54] = uString::Const("Unable to convert '");
    ::STRINGS[55] = uString::Const("' to type ");
...
void Marshal__ToType_fn(uType* __type, uObject* o, uTRef __retval)
{
    ...
    if ((Marshal__TryConvertTo1_fn(__types[1], o, &value, &ret4), ret4))
        ...
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[54/*"Unable to c...*/], o), ::STRINGS[55/*"' to type "*/]), __types[0])));
}
...
double Marshal::ToDouble(uObject* o)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition1(::STRINGS[45/*"Expected nu...*/], ::g::Uno::Object::GetType(uPtr(o))), 1, ::STRINGS[6/*"C:\\Program...*/], 995);
        return 0.0;
    }
}
...
::g::Uno::Float4 Marshal::ToFloat41(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[27/*string*/]))
    {
        ...
        if (::g::Uno::String::StartsWith(uPtr(s), ::STRINGS[46/*"#"*/]))
            return ::g::Uno::Color::FromHex(s);
    }

    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[43/*"Unable to c...*/], o), ::STRINGS[47/*" to float4"*/])));
}
...
::g::Uno::UX::Selector Marshal::ToSelector(uObject* o)
{
    ...
    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::STRINGS[48/*"Unable to p...*/], o)));
}
...
::g::Uno::UX::Size Marshal::ToSize(uObject* o)
{
    ...
    if (uIs(o, ::TYPES[27/*string*/]))
    {
        ...
        else if (::g::Uno::String::EndsWith(uPtr(s), ::STRINGS[49/*"%"*/]))
            return ::g::Uno::UX::Size__Percent(::g::Uno::Float::Parse(::g::Uno::String::Substring1(uPtr(s), 0, uPtr(s)->Length() - 1)));
        else if (::g::Uno::String::EndsWith(uPtr(s), ::STRINGS[50/*"px"*/]))
...
void Context__MethodClosure::ctor_(::g::Fuse::Scripting::Function* cl, ::g::Fuse::Scripting::ScriptMethod* m, ::g::Fuse::Scripting::Context* context)
{
    _m = m;
    _context = context;
    ::g::Fuse::Scripting::Function* factory = uCast< ::g::Fuse::Scripting::Function*>(uPtr(_context)->Evaluate(::STRINGS[24/*"(func)"*/], ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[56/*"(function (...*/], uPtr(m)->Name), ::STRINGS[57/*" = function...*/])), ::TYPES[16/*Fuse.Scripting.Function*/]);
...
{
    ::STRINGS[58] = uString::Const("exports");
    ::STRINGS[59] = uString::Const("disposed");
    ::STRINGS[60] = uString::Const("id");
    ::TYPES[3] = uObject_typeof()->Array();
...
::g::Fuse::Scripting::ModuleResult* Module::Evaluate1(::g::Fuse::Scripting::Context* c, uString* id)
{
    ...
    uPtr(module)->Item(::STRINGS[58/*"exports"*/], c->NewObject());
    module->Item(::STRINGS[59/*"disposed"*/], c->NewArray(uArray::New(::TYPES[3/*object[]*/], 0)));
    ...
    if (::g::Uno::String::op_Inequality(id, NULL))
        uPtr(module)->Item(::STRINGS[60/*"id"*/], id);
...
{
    uObject* r = uPtr(uPtr(Evaluate1(c, id))->Object)->Item(::STRINGS[58/*"exports"*/]);
    return r;
}
// }
...
{
    ::STRINGS[59] = uString::Const("disposed");
    ::STRINGS[61] = uString::Const("(unknown module)");
...
void ModuleResult__ToString_fn(ModuleResult* __this, uString** __retval)
{
    ...
    return *__retval = ::STRINGS[61/*"(unknown mo...*/], void();
}
...
{
    if (uPtr(Object)->ContainsKey(::STRINGS[59/*"disposed"*/]))
    {
        ::g::Fuse::Scripting::Array* disposed = uAs< ::g::Fuse::Scripting::Array*>(uPtr(Object)->Item(::STRINGS[59/*"disposed"*/]), ::TYPES[17/*Fuse.Scripting.Array*/]);
...
{
    ::STRINGS[62] = uString::Const("NativeModule(): Cannot add more members after first use");
    ::STRINGS[58] = uString::Const("exports");
...
void NativeModule__Evaluate_fn(NativeModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result)
{
    ...
    ::g::Fuse::Scripting::Object* obj = uAs< ::g::Fuse::Scripting::Object*>(uPtr(module)->Item(::STRINGS[58/*"exports"*/]), ::TYPES[8/*Fuse.Scripting.Object*/]);
    ...
    if (__this->_func != NULL)
        uPtr(module)->Item(::STRINGS[58/*"exports"*/], uPtr(__this->_func)->CreateCallback());
...
{
    if (_isEvaluated)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[62/*"NativeModul...*/]));
...
{
    ::STRINGS[63] = uString::Const("addSubscriber");
    ::STRINGS[64] = uString::Const("set");
    ::STRINGS[65] = uString::Const("newAt");
    ::STRINGS[66] = uString::Const("newAll");
    ::STRINGS[67] = uString::Const("add");
    ::STRINGS[68] = uString::Const("removeAt");
    ::STRINGS[69] = uString::Const("insertAt");
...
void Observable::ctor_2(::g::Fuse::Scripting::Context* context, ::g::Fuse::Scripting::Object* obj)
{
    ...
    uPtr(obj)->CallMethod(::STRINGS[63/*"addSubscriber"*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 1, (::g::Fuse::Scripting::Function*)_observeChange));
}
...
uObject* Observable::ObserveChange(uArray* args)
{
    ...
    if (::g::Uno::String::op_Equality(op, ::STRINGS[64/*"set"*/]))
    {
        int origin = -1;
    ...
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[65/*"newAt"*/]))
    ...
    else if (::g::Uno::String::op_Equality(op, ::STRINGS[66/*"newAll"*/]))
...
void Context__PropertyClosure::ctor_(::g::Fuse::Scripting::Function* cl, ::g::Fuse::Scripting::ScriptProperty* p, ::g::Fuse::Scripting::Context* context)
{
    ...
    ::g::Fuse::Scripting::Function* definer = uCast< ::g::Fuse::Scripting::Function*>(uPtr(context)->Evaluate(::STRINGS[24/*"(func)"*/], ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[74/*"(function(c...*/], p->Name), ::STRINGS[75/*"', "*/]), ::STRINGS[33/*"{"*/]), ::STRINGS[76/*"get: functi...*/]), ::STRINGS[77/*"var obs = g...*/]), ::STRINGS[78/*"if ("*/]), rawField), ::STRINGS[79/*" != obs) {"*/]), rawField), ::STRINGS[80/*" = obs;"*/]), propField), ::STRINGS[81/*" = obs"*/]), p->Modifier), ::STRINGS[82/*";"*/]), ::STRINGS[36/*"}"*/]), ::STRINGS[83/*"return "*/]), propField), ::STRINGS[36/*"}"*/]), ::STRINGS[84/*"})"*/]), ::STRINGS[84/*"})"*/])), ::TYPES[16/*Fuse.Scripting.Function*/]);
...
static void ScriptModule__RequireContext_build(uType* type)
{
    ...
    ::STRINGS[91] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Scripting\\0.35.12\\$.uno");
...
{
    if (uPtr(args)->Length() != 1)
        U_THROW(::g::Fuse::Scripting::Error::New4(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[85/*"require(): ...*/], uBox<int>(::TYPES[35/*int*/], uPtr(args)->Length())), ::STRINGS[86/*" provided"*/])));
...
uObject* ScriptModule__RequireContext::Require1(uString* id)
{
    ...
    if (module == NULL)
    {
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[89/*"JavaScript ...*/], path), ::STRINGS[93/*" line "*/]), uBox<int>(::TYPES[35/*int*/], uPtr(e)->LineNumber())), ::STRINGS[94/*". "*/]), uPtr(e)->ErrorMessage()), this, ::STRINGS[91/*"C:\\Program...*/], 214, ::STRINGS[92/*"Require"*/]);
    ...
    return uPtr(uPtr(module)->Object)->Item(::STRINGS[58/*"exports"*/]);
}
...
void ScriptMethod1__Call_fn(ScriptMethod1* __this, ::g::Fuse::Scripting::Context* c, uObject* obj, uArray* args, uObject** __retval)
{
    ...
    if (__this->Thread == 2)
    {
        ...
        {
            ::g::Fuse::Diagnostics::InternalError(::STRINGS[101/*"Cannot call...*/], __this, ::STRINGS[6/*"C:\\Program...*/], 1993, ::STRINGS[102/*"Call"*/]);
            return *__retval = NULL, void();
        }
...
static void ScriptModule_build(uType* type)
{
    ...
    ::STRINGS[114] = uString::Const("/index.js");
...
void ScriptModule__GenerateArgs_fn(ScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result, ::g::Uno::Collections::List* args, uString** __retval)
{
    ...
    ::g::Uno::Collections::List__Add_fn(args, uPtr(module)->Item(::STRINGS[58/*"exports"*/]));
...
uString* ScriptModule::ComputePath(uString* moduleId, bool* isFile)
{
    if (::g::Uno::String::EndsWith(uPtr(moduleId), ::STRINGS[104/*".js"*/]))
        moduleId = ::g::Uno::String::Replace1(uPtr(moduleId), ::STRINGS[104/*".js"*/], ::STRINGS[3/*""*/]);
...
bool ScriptModule::IsPathEqual(uString* src, uString* path)
{
    ...
    if (::g::Uno::String::op_Equality(src, ::g::Uno::String::op_Addition2(path, ::STRINGS[114/*"/index.js"*/])))
        return true;
...
{
    ::STRINGS[115] = uString::Const("ScriptProperty: incorrect owner type");
    type->SetFields(2,
...
void ScriptProperty1__GetProperty_fn(ScriptProperty1* __this, ::g::Uno::UX::PropertyObject* owner, ::g::Uno::UX::Property** __retval)
{
    ...
    if (!uIs(owner, __types[0]))
        U_THROW(::g::Uno::Exception::New2(::STRINGS[115/*"ScriptPrope...*/]));
...
{
    ::STRINGS[116] = uString::Const("setValueWithOrigin");
    ::STRINGS[117] = uString::Const("Failed to set Observable value");
    ::STRINGS[6] = uString::Const("C:\\ProgramData\\Uno\\Packages\\FuseCore\\0.35.12\\Scripting\\$.uno");
    ::STRINGS[118] = uString::Const("SetExclusive");
    ::TYPES[2] = ::g::Fuse::Scripting::IObserver_typeof();
    ::TYPES[64] = ::g::Fuse::Scripting::ScriptException_typeof();
    ::TYPES[3] = uObject_typeof()->Array();
    type->SetInterfaces(
...
void Observable__Subscription::SetExclusive(uObject* newValue)
{
    try
    {
        uPtr(uPtr(_om)->Object())->CallMethod(::STRINGS[116/*"setValueWit...*/], uArray::Init<uObject*>(::TYPES[3/*object[]*/], 2, (uObject*)::g::Fuse::Scripting::ValueMirror::Unbox(newValue), uBox<int>(::TYPES[35/*int*/], _origin)));
    }
    catch (const uThrowable& __t)
    {
        if (uIs(__t.Exception, ::TYPES[64/*Fuse.Scripting.ScriptException*/]))
        {
            ...
            ::g::Fuse::Diagnostics::UserScriptError(::STRINGS[117/*"Failed to s...*/], ex, this, ::STRINGS[6/*"C:\\Program...*/], 1475, ::STRINGS[118/*"SetExclusive"*/]);
        }
        else throw __t;
    }
}
