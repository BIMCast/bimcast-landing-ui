...
void NavigateToggle__Perform1_fn(NavigateToggle* __this, uObject* ctx, ::g::Fuse::Node* n)
{
    ...
    if (page != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[9/*"No Page was...*/], __this, ::STRINGS[1/*"C:\\Program...*/], 3240, ::STRINGS[2/*"Perform"*/]);
}
...
uObject* Navigation::TryFindBaseNavigation(::g::Fuse::Node* node)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[10/*"TryFindBase...*/], node, ::STRINGS[1/*"C:\\Program...*/], 1144, ::STRINGS[11/*"TryFindBase...*/]);
        return NULL;
    }
...
::g::Fuse::Visual* Navigation::TryFindPage(::g::Fuse::Node* node, uObject** nav, ::g::Fuse::Visual** pageBind)
{
    ...
    *pageBind = NULL;
    ...
    if (!uPtr(node)->IsRootingStarted())
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[12/*"TryFindPage...*/], node, ::STRINGS[1/*"C:\\Program...*/], 1196, ::STRINGS[13/*"TryFindPage"*/]);
        return NULL;
    }
                ...
                *pageBind = v;
                ...
                if (uPtr(p)->IsRootingStarted())
                {
                    *nav = Navigation::TryFind(p);
                    ...
                    if (*nav == NULL)
                    {
                        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[14/*"`Page` set ...*/], p, ::STRINGS[1/*"C:\\Program...*/], 1217, ::STRINGS[13/*"TryFindPage"*/]);
                        return NULL;
                    }
                }
...
void NavigationPageProxy::OnPageRootingCompleted()
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[15/*"Got an unde...*/], this, ::STRINGS[1/*"C:\\Program...*/], 1347, ::STRINGS[16/*"OnPageRooti...*/]);
        return;
    }
...
void NavigationPageProxy::Rooted(::g::Fuse::Visual* source)
{
    ...
    if (_source == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[17/*"Attempting ...*/], this, ::STRINGS[1/*"C:\\Program...*/], 1310, ::STRINGS[18/*"Rooted"*/]);
        return;
    }
    ...
    if (Page() == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[19/*"Unable to l...*/], this, ::STRINGS[1/*"C:\\Program...*/], 1317, ::STRINGS[18/*"Rooted"*/]);
        return;
    }
    ...
    if (_navigation == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[20/*"Something w...*/], this, ::STRINGS[1/*"C:\\Program...*/], 1334, ::STRINGS[18/*"Rooted"*/]);
        return;
    }
...
void NavigationTriggerAction__Perform_fn(NavigationTriggerAction* __this, ::g::Fuse::Node* n)
{
    ...
    if (ctx == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[21/*"No navigati...*/], __this, ::STRINGS[1/*"C:\\Program...*/], 3149, ::STRINGS[2/*"Perform"*/]);
        return;
    }
...
static void Router_build(uType* type)
{
    ...
    ::STRINGS[29] = uString::Const("GoBack takes no parameters");
    ::STRINGS[1] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Navigation\\0.35.12\\$.uno");
    ::STRINGS[30] = uString::Const("GoBack");
    ::STRINGS[31] = uString::Const("Router.goto(): invalid route provided");
    ::STRINGS[32] = uString::Const("Goto");
    ::STRINGS[33] = uString::Const("Cannot pop() - history is empty");
    ::STRINGS[34] = uString::Const("Pop");
    ::STRINGS[35] = uString::Const("Unable to navigate to route: ");
    ::STRINGS[36] = uString::Const("SetRoute");
    ::STRINGS[37] = uString::Const("No router outlet found to handle route: ");
    ::STRINGS[38] = uString::Const("SetRouteImpl");
    ::STRINGS[39] = uString::Const("SubRoute requested but outlet has no active path: ");
...
void Router::Pop()
{
    ...
    if (uPtr(_history)->Count() == 0)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[33/*"Cannot pop(...*/], this, ::STRINGS[1/*"C:\\Program...*/], 1959, ::STRINGS[34/*"Pop"*/]);
        return;
    }
...
::g::Fuse::Navigation::Route* Router::SetRoute(::g::Fuse::Navigation::Route* r, int gotoMode, int operation, bool userRequest)
{
    ...
    if (outR == NULL)
    {
        uString* msg = ::g::Uno::String::op_Addition2(::STRINGS[35/*"Unable to n...*/], uPtr(r)->Format());

        if (userRequest)
            ::g::Fuse::Diagnostics::UserError(msg, this, ::STRINGS[1/*"C:\\Program...*/], 1981, ::STRINGS[36/*"SetRoute"*/]);
        else
            ::g::Fuse::Diagnostics::InternalError(msg, this, ::STRINGS[1/*"C:\\Program...*/], 1983, ::STRINGS[36/*"SetRoute"*/]);
...
::g::Fuse::Navigation::Route* Router::SetRouteImpl(::g::Fuse::Visual* root, ::g::Fuse::Navigation::Route* r, int gotoMode, int operation)
{
    ...
    if (outlet == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[37/*"No router o...*/], r), this, ::STRINGS[1/*"C:\\Program...*/], 2000, ::STRINGS[38/*"SetRouteImpl"*/]);
        return NULL;
    }
    ...
    if (r->SubRoute != NULL)
    {
        if (active == NULL)
        {
            ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition1(::STRINGS[39/*"SubRoute re...*/], r), this, ::STRINGS[1/*"C:\\Program...*/], 2022, ::STRINGS[38/*"SetRouteImpl"*/]);
            return NULL;
        }
        else
        {
...
void Router::GoBack1(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[29/*"GoBack take...*/], r, ::STRINGS[1/*"C:\\Program...*/], 1743, ::STRINGS[30/*"GoBack"*/]);
        return;
    }
...
void Router::Goto1(::g::Fuse::Scripting::Context* c, Router* r, uArray* args)
{
    ...
    if (where != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[31/*"Router.goto...*/], r, ::STRINGS[1/*"C:\\Program...*/], 1713, ::STRINGS[32/*"Goto"*/]);
}
...
{
    ::STRINGS[40] = uString::Const("Seek being called on an unrooted navigation");
    ::STRINGS[1] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Navigation\\0.35.12\\$.uno");
    ::STRINGS[41] = uString::Const("Fuse.Navigation.ISeekableNavigation.Seek");
...
void StructuredNavigation__FuseNavigationISeekableNavigationSeek_fn(StructuredNavigation* __this, ::g::Fuse::Navigation::UpdateSeekArgs* args)
{
    ...
    if (__this->_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[40/*"Seek being ...*/], __this, ::STRINGS[1/*"C:\\Program...*/], 2585, ::STRINGS[41/*"Fuse.Naviga...*/]);
        return;
    }
...
void StructuredNavigation::GotoImpl(::g::Fuse::Visual* element, int mode)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[42/*"Attempting ...*/], element, ::STRINGS[1/*"C:\\Program...*/], 2293, ::STRINGS[43/*"GotoImpl"*/]);
        SetActive(NULL);
        return;
    }
...
void StructuredNavigation::Motion(::g::Fuse::Motion::MotionConfig* value)
{
    ...
    if (IsRootingCompleted())
        ::g::Fuse::Diagnostics::UserError(::STRINGS[46/*"Motion shou...*/], this, ::STRINGS[1/*"C:\\Program...*/], 2228, ::STRINGS[47/*"set_Motion"*/]);
}
...
void StructuredNavigation::OnUpdated()
{
    ...
    if (_region == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[44/*"Updated cal...*/], this, ::STRINGS[1/*"C:\\Program...*/], 2384, ::STRINGS[45/*"OnUpdated"*/]);
        return;
    }
...
void SwipeNavigate::OnPointerPressed(uObject* sender, ::g::Fuse::Input::PointerPressedArgs* args)
{
    ...
    if (_currentNavigation == NULL)
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[48/*"SwipeNaviga...*/], 1, ::STRINGS[1/*"C:\\Program...*/], 2925);
        return;
    }
...
static void VisualNavigation__cctor_1_fn(uType* __type)
{
    ...
    ::g::Fuse::Scripting::ScriptClass::Register(VisualNavigation_typeof(), uArray::Init< ::g::Fuse::Scripting::ScriptMember*>(::TYPES[24/*Fuse.Scripting.ScriptMember[]*/], 1, (::g::Fuse::Scripting::ScriptMethod1*)::g::Fuse::Scripting::ScriptMethod1::New1(::TYPES[41/*Fuse.Scripting.ScriptMethod<Fuse.Navigation.VisualNavigation>*/], ::STRINGS[26/*"goto"*/], uDelegate::New(::TYPES[42/*Uno.Action<Fuse.Scripting.Context, Fuse.Navigation.VisualNavigation, object[]>*/], (void*)VisualNavigation__gotoNode_fn), 2)));
}
...
void VisualNavigation::gotoNode(::g::Fuse::Scripting::Context* c, VisualNavigation* nav, uArray* args)
{
    ...
    if (target != NULL)
        ...
        ::g::Fuse::Diagnostics::UserError(::STRINGS[50/*"Navigation....*/], nav, ::STRINGS[1/*"C:\\Program...*/], 3366, ::STRINGS[51/*"gotoNode"*/]);
}
// }
