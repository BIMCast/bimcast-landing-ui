...
static void RaiseUserEvent_build(uType* type)
{
    ...
    ::STRINGS[3] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.UserEvents\\0.35.12\\$.uno");
...
void RaiseUserEvent__Perform_fn(RaiseUserEvent* __this, ::g::Fuse::Node* target)
{
    ...
    if (__this->_event == NULL)
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[2/*"no UserEven...*/], ::g::Uno::UX::Selector__op_Implicit1(__this->EventName())), __this, ::STRINGS[3/*"C:\\Program...*/], 240, ::STRINGS[4/*"Perform"*/]);
    else
...
static void ReleasePage_build(uType* type)
{
    ...
    ::STRINGS[6] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Controls.Navigation\\0.35.12\\$.uno");
    ::STRINGS[4] = uString::Const("Perform");
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
...
void ReleasePage__Perform_fn(ReleasePage* __this, ::g::Fuse::Node* n)
{
    ...
    if ((v == NULL) || (nav == NULL))
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[5/*"Requires a ...*/], __this, ::STRINGS[6/*"C:\\Program...*/], 283, ::STRINGS[4/*"Perform"*/]);
        return;
    }
