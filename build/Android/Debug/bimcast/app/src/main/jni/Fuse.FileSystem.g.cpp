...
// C:\ProgramData\Uno\Packages\Fuse.FileSystem\0.35.12\$.uno
// ---------------------------------------------------------
...
{
    {
        ...
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetCacheDirectory241", "()Ljava/lang/String;");
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetExternalCacheDirectory242", "()Ljava/lang/String;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        uString* __result = JniHelper::JavaToUnoString((jstring)__jresult);
        if (__jresult!=NULL && U_JNIVAR->GetObjectRefType(__jresult) == JNILocalRefType) U_JNIVAR->DeleteLocalRef(__jresult);
        ::g::Android::Base::JNI::CheckException();
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetExternalFilesDirectory243", "()Ljava/lang/String;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        uString* __result = JniHelper::JavaToUnoString((jstring)__jresult);
        if (__jresult!=NULL && U_JNIVAR->GetObjectRefType(__jresult) == JNILocalRefType) U_JNIVAR->DeleteLocalRef(__jresult);
        ::g::Android::Base::JNI::CheckException();
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetFilesDirectory244", "()Ljava/lang/String;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        uString* __result = JniHelper::JavaToUnoString((jstring)__jresult);
        if (__jresult!=NULL && U_JNIVAR->GetObjectRefType(__jresult) == JNILocalRefType) U_JNIVAR->DeleteLocalRef(__jresult);
        ::g::Android::Base::JNI::CheckException();
...
// C:\ProgramData\Uno\Packages\Fuse.FileSystem\0.35.12\Uno\IO\$.uno
// ----------------------------------------------------------------
...
// private Uno.Threading.Future<Fuse.FileSystem.Nothing> AppendTextToFile(object[] args) :189
...
// private object AppendTextToFileSync(Fuse.Scripting.Context context, object[] args) :210
...
// public Uno.Threading.Future<Fuse.FileSystem.Nothing> CreateDirectory(object[] args) :237
...
// public object CreateDirectorySync(Fuse.Scripting.Context context, object[] args) :255
...
// private Uno.Threading.Future<Fuse.FileSystem.Nothing> Delete(object[] args) :281
...
// private object DeleteSync(Fuse.Scripting.Context context, object[] args) :301
...
// private Uno.Threading.Future<bool> Exists(object[] args) :327
...
// private object ExistsSync(Fuse.Scripting.Context context, object[] args) :346
...
// private Uno.Collections.Dictionary<string, string> GetAndroidPaths() :362
...
// private string GetCacheDirectory() :382
...
// private Uno.Threading.Future<Fuse.FileSystem.Nothing> AppendTextToFile(object[] args) [instance] :189
...
// private object AppendTextToFileSync(Fuse.Scripting.Context context, object[] args) [instance] :210
...
// public Uno.Threading.Future<Fuse.FileSystem.Nothing> CreateDirectory(object[] args) [instance] :237
...
// public object CreateDirectorySync(Fuse.Scripting.Context context, object[] args) [instance] :255
...
// private Uno.Threading.Future<Fuse.FileSystem.Nothing> Delete(object[] args) [instance] :281
...
// private object DeleteSync(Fuse.Scripting.Context context, object[] args) [instance] :301
...
// private Uno.Threading.Future<bool> Exists(object[] args) [instance] :327
...
// private object ExistsSync(Fuse.Scripting.Context context, object[] args) [instance] :346
...
// private Uno.Collections.Dictionary<string, string> GetAndroidPaths() [instance] :362
::g::Uno::Collections::Dictionary* FileSystemModule::GetAndroidPaths()
{
    return ::g::Fuse::FileSystem::AndroidPaths::GetPathDictionary();
}

// private string GetCacheDirectory() [instance] :382
...
// public sealed class FileSystemOperations :1001
// {
...
// public sealed class Nothing :1318
// {
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetCacheDirectory245", "()Ljava/lang/String;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        uString* __result = JniHelper::JavaToUnoString((jstring)__jresult);
        if (__jresult!=NULL && U_JNIVAR->GetObjectRefType(__jresult) == JNILocalRefType) U_JNIVAR->DeleteLocalRef(__jresult);
        ::g::Android::Base::JNI::CheckException();
...
{
    {
        INIT_JNI;
        jclass __cls = JniHelper::GetNativeExternClass();
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetDataDirectory246", "()Ljava/lang/String;");
        jobject __jresult = U_JNIVAR->CallStaticObjectMethod(__cls,__mtd);
        uString* __result = JniHelper::JavaToUnoString((jstring)__jresult);
        if (__jresult!=NULL && U_JNIVAR->GetObjectRefType(__jresult) == JNILocalRefType) U_JNIVAR->DeleteLocalRef(__jresult);
        ::g::Android::Base::JNI::CheckException();
