...
static void HttpImageSourceImpl_build(uType* type)
{
    ...
    ::STRINGS[8] = uString::Const("HttpImageSource-protocol-failure: ");
    ::TYPES[1] = ::g::Uno::Exception_typeof();
    ::TYPES[13] = ::g::Uno::Action2_typeof()->MakeType(::g::Experimental::Http::HttpResponseHeader_typeof(), ::g::Uno::Buffer_typeof());
    ::TYPES[14] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[2] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::Graphics::Texture2D_typeof());
    ::TYPES[12] = ::g::Uno::Action1_typeof()->MakeType(::g::Uno::Exception_typeof());
    type->SetInterfaces(
        ::g::Fuse::Resources::IMemoryResource_typeof(), offsetof(::g::Fuse::Resources::LoadingImageSource_type, interface0));
...
{
    Fail(::g::Uno::String::op_Addition2(::STRINGS[8/*"HttpImageSo...*/], reason), NULL);
}
...
{
    ::STRINGS[9] = uString::Const("ImageSource error");
    ::STRINGS[10] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Elements\\0.35.12\\Resources\\$.uno");
    ::STRINGS[11] = uString::Const("OnError");
    ::TYPES[0] = ::g::Uno::Action_typeof();
...
{
    ::g::Fuse::Diagnostics::UnknownException(::STRINGS[9/*"ImageSource...*/], e, this, ::STRINGS[10/*"C:\\Program...*/], 570, ::STRINGS[11/*"OnError"*/]);
...
// public void Reload() [instance] :692
...
{
    ::TYPES[17] = ::g::Uno::Collections::ObservableList_typeof()->MakeType(::g::Fuse::Resources::ImageSource_typeof());
    ::TYPES[18] = ::g::Uno::Action1_typeof()->MakeType(::g::Fuse::Resources::ImageSource_typeof());
    ::TYPES[19] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[20] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Resources::ImageSource_typeof());
    type->SetFields(4,
...
{
    ::TYPES[29] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::Type_typeof(), uObject_typeof());
...
{
    ::TYPES[32] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Action_typeof()));
    ::TYPES[33] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Action_typeof());
    ::TYPES[34] = ::g::Uno::Collections::List__Enumerator_typeof()->MakeType(::g::Uno::Action_typeof());
    type->SetFields(0,
