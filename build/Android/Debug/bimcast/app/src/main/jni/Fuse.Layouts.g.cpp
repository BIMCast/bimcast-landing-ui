...
// C:\ProgramData\Uno\Packages\Fuse.Controls.Panels\0.35.12\Layouts\$.uno
// ----------------------------------------------------------------------
...
static void DefinitionBase_build(uType* type)
{
    ...
    ::STRINGS[5] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Controls.Panels\\0.35.12\\Layouts\\$.uno");
...
static void GridLayout_build(uType* type)
{
    ...
    ::TYPES[21] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Layouts::Row_typeof());
    ::TYPES[22] = ::g::Uno::Collections::IListExtensions_typeof()->MakeMethod(1, ::g::Fuse::Layouts::Row_typeof());
    ::TYPES[23] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Layouts::Row_typeof());
    type->SetFields(2,
...
{
    return ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(RowList()), ::TYPES[21/*Uno.Collections.ICollection<Fuse.Layouts.Row>*/]));
}
...
void GridLayout::RowCount(int value)
{
    ...
    while (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(RowList()), ::TYPES[21/*Uno.Collections.ICollection<Fuse.Layouts.Row>*/])) < value)
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(RowList()), ::TYPES[21/*Uno.Collections.ICollection<Fuse.Layouts.Row>*/]), GenDefaultRow());

    while (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(RowList()), ::TYPES[21/*Uno.Collections.ICollection<Fuse.Layouts.Row>*/])) > value)
        ::g::Uno::Collections::IListExtensions__RemoveLast_fn(::TYPES[22/*Uno.Collections.IListExtensions.RemoveLast<Fuse.Layouts.Row>*/], RowList(), &ret31);

    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(RowList()), ::TYPES[21/*Uno.Collections.ICollection<Fuse.Layouts.Row>*/])); ++i)
        uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(RowList()), ::TYPES[23/*Uno.Collections.IList<Fuse.Layouts.Row>*/]), uCRef<int>(i), &ret32), ret32))->Implicit(false);
...
{
    ::g::Uno::Collections::ICollection::Clear(uInterface(uPtr(RowList()), ::TYPES[21/*Uno.Collections.ICollection<Fuse.Layouts.Row>*/]));
...
static void Layout_build(uType* type)
{
    ...
    ::STRINGS[7] = uString::Const("Only a single container is supported for Layout");
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
...
{
    if (Container != NULL)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[7/*"Only a sing...*/]));
...
static void Row_build(uType* type)
{
    ...
    ::TYPES[4] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[5] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Layouts::DefinitionBase__ParseDataItem_typeof());
    ::TYPES[21] = ::g::Uno::Collections::ICollection_typeof()->MakeType(Row_typeof());
    ::TYPES[7] = ::g::Uno::Float_typeof();
    ::TYPES[23] = ::g::Uno::Collections::IList_typeof()->MakeType(Row_typeof());
    type->SetFields(4,
...
void Row::Parse1(uString* data, uObject* output)
{
    ...
    {
        ::g::Fuse::Layouts::DefinitionBase__ParseDataItem item = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[5/*Uno.Collections.IEnumerator<Fuse.Layouts.DefinitionBase.ParseDataItem>*/]), &ret7), ret7);
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(output), ::TYPES[21/*Uno.Collections.ICollection<Fuse.Layouts.Row>*/]), Row::New3(item.Value, item.Metric));
    }
}
...
uString* Row::Serialize1(uObject* rows)
{
    ...
    for (int i = 0; i < ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(rows), ::TYPES[21/*Uno.Collections.ICollection<Fuse.Layouts.Row>*/])); i++)
    {
        if (i > 0)
            s = ::g::Uno::String::op_Addition2(s, ::STRINGS[3/*", "*/]);

        s = ::g::Uno::String::op_Addition2(s, uPtr((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(rows), ::TYPES[23/*Uno.Collections.IList<Fuse.Layouts.Row>*/]), uCRef<int>(i), &ret8), ret8))->Serialize());
    }
...
{
    ::TYPES[25] = ::g::Uno::Float4_typeof()->Array();
    ::TYPES[0] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[11] = ::g::Uno::Float_typeof()->Array();
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
    ::TYPES[2] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Node_typeof());
...
void WrapLayout__ArrangePaddingBox_fn(WrapLayout* __this, uObject* elements, ::g::Uno::Float4* padding, ::g::Fuse::LayoutParams* lp)
{
    ...
    uArray* placements = uArray::New(::TYPES[25/*float4[]*/], ::g::Uno::Collections::ICollection::Count(uInterface(uPtr(elements), ::TYPES[0/*Uno.Collections.ICollection<Fuse.Node>*/])));
