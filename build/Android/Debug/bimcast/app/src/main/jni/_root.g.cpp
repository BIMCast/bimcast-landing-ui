...
// C:\ProgramData\Uno\Packages\Fuse.Controls\0.35.12\.uno\package
// --------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Controls.Native\0.35.12\.uno\package
// ---------------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Controls.Primitives\0.35.12\.uno\package
// -------------------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Controls.Video\0.35.12\.uno\package
// --------------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\FuseCore\0.35.12\.uno\package
// ---------------------------------------------------------
...
static void FuseCore_bundle__cctor__fn(uType* __type)
{
    ...
    FuseCore_bundle::RobotoRegulardb81a0e3_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[34/*"FuseCore"*/]))->GetFile(::STRINGS[35/*"roboto-regu...*/]);
}
...
static void FuseCore_bundle_build(uType* type)
{
    ...
    type->SetFields(0,
        ...
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::FuseCore_bundle::RobotoRegulardb81a0e3_, uFieldFlagsStatic);
}
...
uSStrong< ::g::Uno::IO::BundleFile*> FuseCore_bundle::RobotoRegulardb81a0e3_;
// }

// C:\ProgramData\Uno\Packages\Fuse.Drawing\0.35.12\.uno\package
// -------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Drawing.Primitives\0.35.12\.uno\package
// ------------------------------------------------------------------------
...
{
    FuseDrawingPrimitives_bundle::Circle08de7d46_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[38/*"uniform vec...*/], ::STRINGS[39/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 14, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[27/*"m"*/], ::STRINGS[40/*"p"*/]));
    FuseDrawingPrimitives_bundle::Circle0dcbf8a6_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[41/*"uniform vec...*/], ::STRINGS[42/*"uniform vec...*/], 1, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 21, ::STRINGS[3/*"b"*/], ::STRINGS[2/*"a"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[27/*"m"*/], ::STRINGS[18/*"n"*/], ::STRINGS[28/*"o"*/], ::STRINGS[40/*"p"*/], ::STRINGS[29/*"q"*/], ::STRINGS[43/*"r"*/], ::STRINGS[44/*"s"*/], ::STRINGS[45/*"t"*/], ::STRINGS[46/*"w"*/]));
    FuseDrawingPrimitives_bundle::Circle205f8541_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[47/*"uniform vec...*/], ::STRINGS[48/*"uniform vec...*/], 1, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 16, ::STRINGS[3/*"b"*/], ::STRINGS[2/*"a"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[27/*"m"*/], ::STRINGS[18/*"n"*/], ::STRINGS[28/*"o"*/], ::STRINGS[43/*"r"*/]));
    FuseDrawingPrimitives_bundle::Circle3e0df8a6_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[49/*"uniform vec...*/], ::STRINGS[50/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 12, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/]));
    FuseDrawingPrimitives_bundle::Circle54d7f8a6_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[51/*"uniform vec...*/], ::STRINGS[52/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 15, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[27/*"m"*/], ::STRINGS[18/*"n"*/], ::STRINGS[28/*"o"*/]));
    FuseDrawingPrimitives_bundle::Circle5628667c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[49/*"uniform vec...*/], ::STRINGS[53/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 12, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/]));
    FuseDrawingPrimitives_bundle::Circle65ae6e77_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[54/*"uniform vec...*/], ::STRINGS[55/*"uniform vec...*/], 1, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 19, ::STRINGS[3/*"b"*/], ::STRINGS[2/*"a"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[27/*"m"*/], ::STRINGS[18/*"n"*/], ::STRINGS[28/*"o"*/], ::STRINGS[40/*"p"*/], ::STRINGS[29/*"q"*/], ::STRINGS[43/*"r"*/], ::STRINGS[56/*"u"*/]));
    FuseDrawingPrimitives_bundle::Circle663708ab_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[57/*"uniform vec...*/], ::STRINGS[58/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 17, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[27/*"m"*/], ::STRINGS[18/*"n"*/], ::STRINGS[28/*"o"*/], ::STRINGS[40/*"p"*/], ::STRINGS[44/*"s"*/]));
    FuseDrawingPrimitives_bundle::Circle6b9cf8a6_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[41/*"uniform vec...*/], ::STRINGS[59/*"uniform vec...*/], 1, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 21, ::STRINGS[3/*"b"*/], ::STRINGS[2/*"a"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[27/*"m"*/], ::STRINGS[18/*"n"*/], ::STRINGS[28/*"o"*/], ::STRINGS[40/*"p"*/], ::STRINGS[29/*"q"*/], ::STRINGS[43/*"r"*/], ::STRINGS[44/*"s"*/], ::STRINGS[45/*"t"*/], ::STRINGS[46/*"w"*/]));
    FuseDrawingPrimitives_bundle::Circle85b410a6_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[60/*"uniform vec...*/], ::STRINGS[61/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 10, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/]));
    FuseDrawingPrimitives_bundle::Circle940fd686_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[62/*"uniform vec...*/], ::STRINGS[63/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 16, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[27/*"m"*/], ::STRINGS[18/*"n"*/], ::STRINGS[28/*"o"*/], ::STRINGS[43/*"r"*/]));
    FuseDrawingPrimitives_bundle::Circle940fd687_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[64/*"uniform vec...*/], ::STRINGS[65/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 19, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[27/*"m"*/], ::STRINGS[18/*"n"*/], ::STRINGS[28/*"o"*/], ::STRINGS[40/*"p"*/], ::STRINGS[29/*"q"*/], ::STRINGS[43/*"r"*/], ::STRINGS[56/*"u"*/]));
    FuseDrawingPrimitives_bundle::Circle9aeeb57e_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[66/*"uniform vec...*/], ::STRINGS[67/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 13, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[27/*"m"*/]));
    FuseDrawingPrimitives_bundle::Circleb380f1e1_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[49/*"uniform vec...*/], ::STRINGS[68/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 12, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/]));
    FuseDrawingPrimitives_bundle::Circlec306f9dc_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[54/*"uniform vec...*/], ::STRINGS[69/*"uniform vec...*/], 1, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 19, ::STRINGS[3/*"b"*/], ::STRINGS[2/*"a"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[27/*"m"*/], ::STRINGS[18/*"n"*/], ::STRINGS[28/*"o"*/], ::STRINGS[40/*"p"*/], ::STRINGS[29/*"q"*/], ::STRINGS[43/*"r"*/], ::STRINGS[56/*"u"*/]));
    FuseDrawingPrimitives_bundle::Circlec38f9410_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[57/*"uniform vec...*/], ::STRINGS[70/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 17, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[27/*"m"*/], ::STRINGS[18/*"n"*/], ::STRINGS[28/*"o"*/], ::STRINGS[40/*"p"*/], ::STRINGS[44/*"s"*/]));
    FuseDrawingPrimitives_bundle::Circlec977f8a6_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[64/*"uniform vec...*/], ::STRINGS[71/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 19, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[27/*"m"*/], ::STRINGS[18/*"n"*/], ::STRINGS[28/*"o"*/], ::STRINGS[40/*"p"*/], ::STRINGS[29/*"q"*/], ::STRINGS[43/*"r"*/], ::STRINGS[56/*"u"*/]));
    FuseDrawingPrimitives_bundle::Circlee03cf8a6_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[51/*"uniform vec...*/], ::STRINGS[72/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 15, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[27/*"m"*/], ::STRINGS[18/*"n"*/], ::STRINGS[28/*"o"*/]));
    FuseDrawingPrimitives_bundle::Circleecb159f0_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[73/*"uniform vec...*/], ::STRINGS[74/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 14, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[27/*"m"*/], ::STRINGS[18/*"n"*/]));
    FuseDrawingPrimitives_bundle::Circleecb259f0_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[73/*"uniform vec...*/], ::STRINGS[75/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 14, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[27/*"m"*/], ::STRINGS[18/*"n"*/]));
    FuseDrawingPrimitives_bundle::Circleecb759f0_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[76/*"uniform vec...*/], ::STRINGS[77/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 11, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/]));
    FuseDrawingPrimitives_bundle::Circlef701f8a6_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[78/*"uniform vec...*/], ::STRINGS[79/*"uniform vec...*/], 1, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 18, ::STRINGS[3/*"b"*/], ::STRINGS[2/*"a"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[27/*"m"*/], ::STRINGS[18/*"n"*/], ::STRINGS[28/*"o"*/], ::STRINGS[40/*"p"*/], ::STRINGS[29/*"q"*/], ::STRINGS[45/*"t"*/]));
    FuseDrawingPrimitives_bundle::Circlef84740e3_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[66/*"uniform vec...*/], ::STRINGS[80/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 13, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[27/*"m"*/]));
    FuseDrawingPrimitives_bundle::Circlef8cfdb17_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[81/*"uniform vec...*/], ::STRINGS[82/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 9, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/]));
    FuseDrawingPrimitives_bundle::Rectangle694a75d0_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[83/*"uniform flo...*/], ::STRINGS[84/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 16, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[27/*"m"*/], ::STRINGS[18/*"n"*/], ::STRINGS[28/*"o"*/], ::STRINGS[45/*"t"*/]));
    FuseDrawingPrimitives_bundle::Rectangle694a75d1_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[85/*"uniform flo...*/], ::STRINGS[86/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 11, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/]));
    FuseDrawingPrimitives_bundle::Rectangle694a75da_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[87/*"uniform flo...*/], ::STRINGS[88/*"uniform vec...*/], 2, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 18, ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[27/*"m"*/], ::STRINGS[18/*"n"*/], ::STRINGS[28/*"o"*/], ::STRINGS[40/*"p"*/], ::STRINGS[29/*"q"*/], ::STRINGS[89/*"v"*/]));
    FuseDrawingPrimitives_bundle::Rectangle694a75db_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[90/*"uniform flo...*/], ::STRINGS[91/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 12, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/]));
    FuseDrawingPrimitives_bundle::Rectangledeaca36a_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[92/*"uniform flo...*/], ::STRINGS[93/*"uniform vec...*/], 2, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 20, ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[27/*"m"*/], ::STRINGS[18/*"n"*/], ::STRINGS[28/*"o"*/], ::STRINGS[40/*"p"*/], ::STRINGS[29/*"q"*/], ::STRINGS[43/*"r"*/], ::STRINGS[44/*"s"*/], ::STRINGS[94/*"x"*/]));
    FuseDrawingPrimitives_bundle::Rectangledeaca36b_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[95/*"uniform flo...*/], ::STRINGS[96/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 14, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[27/*"m"*/], ::STRINGS[18/*"n"*/]));
    FuseDrawingPrimitives_bundle::Rectangledeaca370_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[97/*"uniform flo...*/], ::STRINGS[98/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 18, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[27/*"m"*/], ::STRINGS[18/*"n"*/], ::STRINGS[28/*"o"*/], ::STRINGS[40/*"p"*/], ::STRINGS[29/*"q"*/], ::STRINGS[89/*"v"*/]));
    FuseDrawingPrimitives_bundle::Rectangledeaca371_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[99/*"uniform flo...*/], ::STRINGS[100/*"uniform flo...*/], 1, 3, uArray::Init<uString*>(::TYPES[0/*string[]*/], 13, ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[27/*"m"*/]));
}

static void FuseDrawingPrimitives_bundle_build(uType* type)
{
    ::STRINGS[38] = uString::Const("uniform vec2 b, c, e, f, g, l;\n"
        "uniform mat4 d;\n"
        "uniform float m;\n"
        "\n"
        "attribute vec2 a;\n"
        ...
        "}\n"
        "");
    ::STRINGS[39] = uString::Const("uniform float h, i, j, k;\n"
        "\n"
        "uniform sampler2D p;\n"
        "\n"
        "varying float n;\n"
    ...
    ::STRINGS[48] = uString::Const("uniform vec4 k;\n"
        ...
        "}\n"
        "");
    ::STRINGS[49] = uString::Const("uniform vec2 b, c;\n"
        "uniform mat4 d;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[50] = uString::Const("uniform float e, f, g, h, i, j, l;\n"
        "uniform vec3 k;\n"
        "\n"
        "varying vec2 m;\n"
        "\n"
    ...
    ::STRINGS[51] = uString::Const("uniform vec2 b, c;\n"
        ...
        "}\n"
        "");
    ::STRINGS[52] = uString::Const("uniform float e, f, g, h, i, j, l;\n"
        "uniform vec2 m, n, o;\n"
        "uniform vec3 k;\n"
        "\n"
        "varying vec2 p;\n"
        ...
        "}\n"
        "");
    ::STRINGS[53] = uString::Const("uniform float e, f, g, h;\n"
        "uniform vec2 j, k, l;\n"
        "uniform vec3 i;\n"
        "\n"
        "varying vec2 m;\n"
    ...
    ::STRINGS[57] = uString::Const("uniform vec2 b, c, e, f, g, l;\n"
        "uniform mat4 d;\n"
        "uniform float m;\n"
        "\n"
        "attribute vec2 a;\n"
        ...
        "}\n"
        "");
    ::STRINGS[58] = uString::Const("uniform float h, i, j, k;\n"
        "uniform vec2 n, o, p;\n"
        "\n"
        "uniform sampler2D s;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[59] = uString::Const("uniform vec4 k;\n"
        "uniform float l, m, n, o, p, q;\n"
        "uniform vec2 r, s, t;\n"
        "\n"
        "uniform sampler2D w;\n"
    ...
    ::STRINGS[63] = uString::Const("uniform float h, i, j, k, l, m;\n"
        ...
        "}\n"
        "");
    ::STRINGS[64] = uString::Const("uniform vec2 b, c, e, f, g, n;\n"
        "uniform mat4 d;\n"
        "uniform float o;\n"
        "\n"
        "attribute vec2 a;\n"
        ...
        "}\n"
        "");
    ::STRINGS[65] = uString::Const("uniform float h, i, j, k, l, m;\n"
        "uniform vec2 p, q, r;\n"
        "\n"
        "uniform sampler2D u;\n"
        "\n"
    ...
    ::STRINGS[66] = uString::Const("uniform vec2 b, c;\n"
        ...
        "}\n"
        "");
    ::STRINGS[67] = uString::Const("uniform float e, f, g, h, j;\n"
        "uniform vec2 k, l, m;\n"
        "uniform vec3 i;\n"
        "\n"
        "varying vec2 n;\n"
    ...
    ::STRINGS[82] = uString::Const("uniform float e, f, g, h;\n"
        ...
        "}\n"
        "");
    ::STRINGS[83] = uString::Const("uniform float e[d], o;\n"
        ...
        "}\n"
        "");
    ::STRINGS[84] = uString::Const("uniform float k, l, m;\n"
        "\n"
        "uniform sampler2D t;\n"
        "\n"
        "varying float p, q;\n"
        ...
        "}\n"
        "");
    ::STRINGS[85] = uString::Const("uniform float e[d];\n"
        "uniform vec2 f;\n"
        "uniform mat4 g;\n"
        "\n"
        "attribute vec4 a, b;\n"
    ...
    ::STRINGS[90] = uString::Const("uniform float e[d];\n"
        ...
        "}\n"
        "");
    ::STRINGS[91] = uString::Const("uniform float h, i, j, l;\n"
        "uniform vec3 k;\n"
        "\n"
        "varying float m;\n"
        "varying vec2 n, o;\n"
...
// C:\ProgramData\Uno\Packages\Fuse.Effects\0.35.12\.uno\package
// -------------------------------------------------------------
...
{
    FuseEffects_bundle::Blitterec98f148_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[101/*"uniform mat...*/], ::STRINGS[102/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[11/*"h"*/]));
    FuseEffects_bundle::Desaturate1f514108_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[103/*"uniform mat...*/], ::STRINGS[104/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 5, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[9/*"f"*/]));
    FuseEffects_bundle::EffectHelpers0ae20243_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[105/*"uniform vec...*/], ::STRINGS[106/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 8, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[27/*"m"*/]));
    FuseEffects_bundle::EffectHelpersa4726cf5_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[107/*"attribute v...*/], ::STRINGS[108/*"uniform flo...*/], 3, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[2/*"a"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[11/*"h"*/]));
    FuseEffects_bundle::EffectHelpersf4e3f746_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[109/*"uniform vec...*/], ::STRINGS[110/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 11, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[45/*"t"*/]));
    FuseEffects_bundle::EffectHelpersf791727a_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[111/*"attribute v...*/], ::STRINGS[112/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 2, ::STRINGS[2/*"a"*/], ::STRINGS[4/*"c"*/]));
    FuseEffects_bundle::Halftone1ff68c3c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[113/*"uniform mat...*/], ::STRINGS[114/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 14, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[27/*"m"*/], ::STRINGS[29/*"q"*/]));
    FuseEffects_bundle::Mask85b813a2_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[115/*"uniform mat...*/], ::STRINGS[116/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/]));
    FuseEffects_bundle::Maske38913a2_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[115/*"uniform mat...*/], ::STRINGS[117/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/]));
    FuseEffects_bundle::Maskfa5313a2_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[115/*"uniform mat...*/], ::STRINGS[118/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 7, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/]));
}

static void FuseEffects_bundle_build(uType* type)
{
    ::STRINGS[101] = uString::Const("uniform mat4 f, b;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        "varying vec2 g;\n"
        ...
        "}\n"
        "");
    ::STRINGS[102] = uString::Const("uniform vec3 e;\n"
        "uniform float c, d;\n"
        "\n"
        "uniform sampler2D h;\n"
        "\n"
    ...
    ::STRINGS[9] = uString::Const("f");
    ::STRINGS[11] = uString::Const("h");
    ::STRINGS[103] = uString::Const("uniform mat4 d, b;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        "varying vec2 e;\n"
        ...
        "}\n"
        "");
    ::STRINGS[104] = uString::Const("uniform float c;\n"
        "\n"
        "uniform sampler2D f;\n"
        "\n"
        "varying vec2 e;\n"
        ...
        "}\n"
        "");
    ::STRINGS[105] = uString::Const("uniform vec2 c, e, f, g;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[106] = uString::Const("uniform float b, d;\n"
        "\n"
        "uniform sampler2D m;\n"
        "\n"
        "varying vec2 h, i, j, k, l;\n"
    ...
    ::STRINGS[10] = uString::Const("g");
    ::STRINGS[27] = uString::Const("m");
    ::STRINGS[107] = uString::Const("attribute vec2 a;\n"
        "\n"
        "varying vec2 g;\n"
        "\n"
        "void main()\n"
        ...
        "}\n"
        "");
    ::STRINGS[108] = uString::Const("uniform float e[b];\n"
        "uniform vec2 f[d];\n"
        "\n"
        "uniform sampler2D h;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[109] = uString::Const("uniform vec2 c, e, f, h, i, j;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[110] = uString::Const("uniform float b, d, g;\n"
        "\n"
        "uniform sampler2D t;\n"
        "\n"
        "varying vec2 k, l, m, n, o, p, q, r, s;\n"
    ...
    ::STRINGS[112] = uString::Const("uniform sampler2D c;\n"
        ...
        "}\n"
        "");
    ::STRINGS[113] = uString::Const("uniform mat4 m, b;\n"
        "uniform vec2 g, h;\n"
        "uniform mat2 i;\n"
        "\n"
        "attribute vec2 a;\n"
        ...
        "}\n"
        "");
    ::STRINGS[114] = uString::Const("uniform float c, d, e, f, k, l;\n"
        "uniform mat2 j;\n"
        "\n"
        "uniform sampler2D q;\n"
        "\n"
    ...
    ::STRINGS[14] = uString::Const("l");
    ::STRINGS[29] = uString::Const("q");
    ::STRINGS[115] = uString::Const("uniform mat4 e, b;\n"
        "uniform vec2 c, d;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[116] = uString::Const("uniform sampler2D h, i;\n"
        "\n"
        "varying vec2 f, g;\n"
        "\n"
        "void main()\n"
        ...
        "}\n"
        "");
    ::STRINGS[117] = uString::Const("uniform sampler2D h, i;\n"
        "\n"
        "varying vec2 f, g;\n"
        "\n"
        "void main()\n"
        ...
        "}\n"
        "");
    ::STRINGS[118] = uString::Const("uniform sampler2D h, i;\n"
        "\n"
        "varying vec2 f, g;\n"
        "\n"
        "void main()\n"
...
// C:\ProgramData\Uno\Packages\Fuse.Elements\0.35.12\.uno\package
// --------------------------------------------------------------
...
{
    FuseElements_bundle::CacheHelper6627cb47_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[119/*"uniform vec...*/], ::STRINGS[120/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 6, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[10/*"g"*/]));
    FuseElements_bundle::ElementBatch2ee7bdf7_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[121/*"uniform mat...*/], ::STRINGS[122/*"uniform sam...*/], 0, 2, uArray::Init<uString*>(::TYPES[0/*string[]*/], 4, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[9/*"f"*/]));
    FuseElements_bundle::Scale9Rectangle12a651af_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[123/*"uniform flo...*/], ::STRINGS[124/*"uniform vec...*/], 0, 2, uArray::Init<uString*>(::TYPES[0/*string[]*/], 17, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[27/*"m"*/], ::STRINGS[18/*"n"*/], ::STRINGS[28/*"o"*/], ::STRINGS[40/*"p"*/], ::STRINGS[43/*"r"*/]));
}

static void FuseElements_bundle_build(uType* type)
{
    ::STRINGS[119] = uString::Const("uniform vec2 b;\n"
        "uniform mat4 c, d;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[120] = uString::Const("uniform float e;\n"
        "\n"
        "uniform sampler2D g;\n"
        "\n"
        "varying vec2 f;\n"
    ...
    ::STRINGS[8] = uString::Const("e");
    ::STRINGS[10] = uString::Const("g");
    ::STRINGS[121] = uString::Const("uniform mat4 c;\n"
        "\n"
        "attribute vec3 a;\n"
        "attribute vec2 b;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[122] = uString::Const("uniform sampler2D f;\n"
        "\n"
        "varying float d;\n"
        "varying vec2 e;\n"
        "\n"
        ...
        "");
    ::STRINGS[9] = uString::Const("f");
    ::STRINGS[123] = uString::Const("uniform float c, d, e, f, g, h, k, l, m, n;\n"
        "uniform mat4 i, j;\n"
        "uniform vec2 o;\n"
        "\n"
        "attribute vec3 a, b;\n"
        ...
        "}\n"
        "");
    ::STRINGS[124] = uString::Const("uniform vec4 p;\n"
        "\n"
        "uniform sampler2D r;\n"
        "\n"
        "varying vec2 q;\n"
...
// C:\ProgramData\Uno\Packages\Fuse.Entities\0.35.12\.uno\package
// --------------------------------------------------------------
...
{
    FuseEntities_bundle::Blur6e490521_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[125/*"uniform vec...*/], ::STRINGS[126/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 4, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[11/*"h"*/]));
    FuseEntities_bundle::FindEdges5437027c_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[127/*"uniform vec...*/], ::STRINGS[128/*"uniform flo...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 9, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[18/*"n"*/]));
    FuseEntities_bundle::MeshBatchingEngine54fb35e2_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[129/*"uniform mat...*/], ::STRINGS[130/*"uniform vec...*/], 3, 4, uArray::Init<uString*>(::TYPES[0/*string[]*/], 19, ::STRINGS[8/*"e"*/], ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[11/*"h"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[27/*"m"*/], ::STRINGS[18/*"n"*/], ::STRINGS[28/*"o"*/], ::STRINGS[40/*"p"*/], ::STRINGS[89/*"v"*/], ::STRINGS[46/*"w"*/], ::STRINGS[94/*"x"*/]));
    FuseEntities_bundle::MeshBatchingEnginee840d347_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[131/*"uniform mat...*/], ::STRINGS[132/*"uniform vec...*/], 3, 5, uArray::Init<uString*>(::TYPES[0/*string[]*/], 20, ::STRINGS[9/*"f"*/], ::STRINGS[10/*"g"*/], ::STRINGS[11/*"h"*/], ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/], ::STRINGS[5/*"d"*/], ::STRINGS[8/*"e"*/], ::STRINGS[12/*"i"*/], ::STRINGS[13/*"j"*/], ::STRINGS[17/*"k"*/], ::STRINGS[14/*"l"*/], ::STRINGS[27/*"m"*/], ::STRINGS[18/*"n"*/], ::STRINGS[28/*"o"*/], ::STRINGS[40/*"p"*/], ::STRINGS[29/*"q"*/], ::STRINGS[46/*"w"*/], ::STRINGS[94/*"x"*/], ::STRINGS[133/*"y"*/]));
    FuseEntities_bundle::MeshRenderer47c4cfe0_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[134/*"uniform mat...*/], ::STRINGS[135/*"void main()...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 2, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/]));
    FuseEntities_bundle::MeshRendererb55bfadc_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[136/*"uniform mat...*/], ::STRINGS[137/*"uniform vec...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 3, ::STRINGS[2/*"a"*/], ::STRINGS[3/*"b"*/], ::STRINGS[4/*"c"*/]));
    FuseEntities_bundle::RenderToTexturea069a95b_ = ::g::Uno::Runtime::Implementation::ShaderBackends::OpenGL::GLProgram::Create(::STRINGS[138/*"attribute v...*/], ::STRINGS[112/*"uniform sam...*/], 0, 1, uArray::Init<uString*>(::TYPES[0/*string[]*/], 2, ::STRINGS[2/*"a"*/], ::STRINGS[4/*"c"*/]));
}

static void FuseEntities_bundle_build(uType* type)
{
    ::STRINGS[125] = uString::Const("uniform vec2 b, c;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[126] = uString::Const("uniform sampler2D h;\n"
        "\n"
        "varying vec2 d, e, f, g;\n"
        "\n"
        "void main()\n"
    ...
    ::STRINGS[4] = uString::Const("c");
    ::STRINGS[11] = uString::Const("h");
    ::STRINGS[127] = uString::Const("uniform vec2 b, c, d, e;\n"
        "\n"
        "attribute vec2 a;\n"
        "\n"
        ...
        "}\n"
        "");
    ::STRINGS[128] = uString::Const("uniform float f;\n"
        "uniform vec4 g, h;\n"
        "\n"
        "uniform sampler2D n;\n"
        "\n"
    ...
    ::STRINGS[10] = uString::Const("g");
    ::STRINGS[18] = uString::Const("n");
    ::STRINGS[129] = uString::Const("uniform mat4 o, l, p;\n"
        "uniform vec2 h, i;\n"
        "\n"
        "attribute vec3 a, d;\n"
        "attribute vec2 b;\n"
        ...
        "}\n"
        "");
    ::STRINGS[130] = uString::Const("uniform vec3 j, k, m;\n"
        "uniform float n;\n"
        "\n"
    ...
    ::STRINGS[46] = uString::Const("w");
    ::STRINGS[94] = uString::Const("x");
    ::STRINGS[131] = uString::Const("uniform mat4 i[16], q, m[16];\n"
        "uniform vec2 j, k;\n"
        "\n"
        "attribute vec3 a, e;\n"
        "attribute float b;\n"
        ...
        "}\n"
        "");
    ::STRINGS[132] = uString::Const("uniform vec3 l, n, o;\n"
        "uniform float p;\n"
        "\n"
        ...
        "");
    ::STRINGS[29] = uString::Const("q");
    ::STRINGS[133] = uString::Const("y");
    ::STRINGS[134] = uString::Const("uniform mat4 b;\n"
        "\n"
        "attribute vec3 a;\n"
        "\n"
        "void main()\n"
        ...
        "}\n"
        "");
    ::STRINGS[135] = uString::Const("void main()\n"
        "{\n"
        "    gl_FragColor = vec4(0.8, 0.85, 1.0, 1.0);\n"
        "}\n"
        "");
    ::STRINGS[136] = uString::Const("uniform mat4 c;\n"
        "\n"
        "attribute vec3 a;\n"
        "\n"
        "void main()\n"
        ...
        "}\n"
        "");
    ::STRINGS[137] = uString::Const("uniform vec4 b;\n"
        "\n"
        "void main()\n"
        "{\n"
        "    gl_FragColor = b;\n"
...
// C:\ProgramData\Uno\Packages\Fuse.Reactive\0.35.12\.uno\package
// --------------------------------------------------------------
...
{
    FuseReactive_bundle::es6promise4bde52e5_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[139/*"Fuse.Reactive"*/]))->GetFile(::STRINGS[140/*"es6-promise...*/]);
    FuseReactive_bundle::Observable8fa3ae58_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[139/*"Fuse.Reactive"*/]))->GetFile(::STRINGS[141/*"observable-...*/]);
}

static void FuseReactive_bundle_build(uType* type)
{
    ::STRINGS[139] = uString::Const("Fuse.Reactive");
    ::STRINGS[140] = uString::Const("es6-promise-fadcfa3d.js");
    ::STRINGS[141] = uString::Const("observable-1227c90e.js");
    type->SetFields(0,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::FuseReactive_bundle::es6promise4bde52e5_, uFieldFlagsStatic,
        ::g::Uno::IO::BundleFile_typeof(), (uintptr_t)&::g::FuseReactive_bundle::Observable8fa3ae58_, uFieldFlagsStatic);
}
...
uSStrong< ::g::Uno::IO::BundleFile*> FuseReactive_bundle::es6promise4bde52e5_;
uSStrong< ::g::Uno::IO::BundleFile*> FuseReactive_bundle::Observable8fa3ae58_;
// }

// C:\Users\ManailMJ\Documents\Dev\fuse\projects\bimcast\fuse_modules\bolav\fuse-homescreen\HomeScreen.uno
// -------------------------------------------------------------------------------------------------------

// public enum HomeScreenType :8
uEnumType* HomeScreenType_typeof()
{
    static uSStrong<uEnumType*> type;
    if (type != NULL) return type;

    type = uEnumType::New("HomeScreenType", ::g::Uno::Int_typeof(), 2);
    type->SetLiterals(
        "Finish", 0LL,
        "CallIntent", 1LL);
    return type;
