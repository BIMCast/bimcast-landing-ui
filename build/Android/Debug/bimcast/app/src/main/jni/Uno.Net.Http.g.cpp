...
// C:\ProgramData\Uno\Packages\Uno.Net.Http\0.35.8\$.uno
// -----------------------------------------------------
...
static void HttpMessageCache_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Uno.Net.Http\\0.35.8\\$.uno");
...
void HttpMessageCache::IsCacheEnabled(bool value)
{
    ...
    if (HttpMessageCache::_isInitialized())
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[0/*"Uno.Net.Htt...*/], 1, ::STRINGS[1/*"C:\\Program...*/], 17);
    else
