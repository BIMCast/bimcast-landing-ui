...
public class AppRoot
{
    ...
    public static void ClearRootView210(final Object handle)
    {
        ((android.widget.RelativeLayout)handle).removeAllViews();
    }
    
    public static Object CreateRootView211()
    {
        android.widget.RelativeLayout relativeLayout = new android.widget.RelativeLayout(com.apps.bimcast.bimcast.GetRootActivity()) {
        					...
        					public boolean onTouchEvent(android.view.MotionEvent motionEvent) {
        						...
        						ExternedBlockHost.callUno_Fuse_Android_AppRoot_OnTouchEvent__212(motionEvent,UnoHelper.GetUnoObjectRef(motionEvent));
    ...
    public static void SetChildSize1213(final Object handle,final int w,final int h)
    {
    ...
    public static void SetRootView214(final Object handle,final Object rootHandle)
    {
