...
//#else
public class bimcast extends android.app.Activity implements ActivityCompat.OnRequestPermissionsResultCallback
//#endif
{
...
//#endif
    ...
    {
    	bimcast activity = _appState.CurrentActivity;
...
public static native void __n_onLowMemory();
    ...
    public static bimcast RootActivity()
    {
        return _appState.CurrentActivity;
    }
