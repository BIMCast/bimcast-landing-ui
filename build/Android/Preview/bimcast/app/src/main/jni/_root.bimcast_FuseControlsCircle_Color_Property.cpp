...
{
    uStackFrame __("bimcast_FuseControlsCircle_Color_Property", "Get()");
...
{
    uStackFrame __("bimcast_FuseControlsCircle_Color_Property", "get_Object()");
...
{
    uStackFrame __("bimcast_FuseControlsCircle_Color_Property", "Set(float4,Uno.UX.IPropertyListener)");
    ::g::Uno::Float4 v_ = *v;
...
{
    uStackFrame __("bimcast_FuseControlsCircle_Color_Property", "get_SupportsOriginSetter()");
...
{
    uStackFrame __("bimcast_FuseControlsCircle_Color_Property", ".ctor(Fuse.Controls.Circle,Uno.UX.Selector)");
    ctor_1(name);
    _obj = obj;
}
