...
// C:\ProgramData\Uno\Packages\FuseJS\0.35.12\$.uno
// ------------------------------------------------

// public sealed class Base64 :375
// {
...
// private object DecodeAscii(Fuse.Scripting.Context context, object[] args) :410
...
// private object DecodeUtf8(Fuse.Scripting.Context context, object[] args) :442
...
// private object EncodeAscii(Fuse.Scripting.Context context, object[] args) :394
...
// private object EncodeUtf8(Fuse.Scripting.Context context, object[] args) :426
...
// private object DecodeAscii(Fuse.Scripting.Context context, object[] args) [instance] :410
...
// private object DecodeUtf8(Fuse.Scripting.Context context, object[] args) [instance] :442
...
// private object EncodeAscii(Fuse.Scripting.Context context, object[] args) [instance] :394
...
// private object EncodeUtf8(Fuse.Scripting.Context context, object[] args) [instance] :426
...
// public sealed class Bundle :477
// {
...
// private static object Read(Fuse.Scripting.Context c, object[] args) [static] :547
...
// private static string Read(string filename) [static] :557
...
// private static Uno.Threading.Future<string> ReadAsync(object[] args) [static] :521
...
// private static Uno.Threading.Future<string> ReadAsync(string filename) [static] :574
...
// private static bool TryGetBundleFile(string sourcePath, Uno.IO.BundleFile& bundleFile) [static] :489
...
// private sealed class FileReaderImpl.FileReadCommand :610
// {
...
// public string ReadAsDataURL() :621
...
// public FileReadCommand(string path) [instance] :613
...
// public string ReadAsDataURL() [instance] :621
...
// public string ReadAsText() [instance] :617
...
// public FileReadCommand New(string path) [static] :613
...
// public sealed class FileReaderImpl :608
// {
...
// private static Uno.Threading.Future<string> readAsText(object[] args) :645
...
// public FileReaderImpl() [instance] :631
...
// public FileReaderImpl New() [static] :631
...
// private static Uno.Threading.Future<string> readAsDataURL(object[] args) [static] :639
...
// private static Uno.Threading.Future<string> readAsText(object[] args) [static] :645
...
// internal sealed class RaiseEvent :662
// {
static void RaiseEvent_build(uType* type)
{
    ::STRINGS[38] = uString::Const("Cannot find message with name: ");
    ::STRINGS[39] = uString::Const("C:\\ProgramData\\Uno\\Packages\\FuseJS\\0.35.12\\$.uno");
...
void RaiseEvent::Raise()
{
    ...
    if (dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[38/*"Cannot find...*/], Name), this, ::STRINGS[39/*"C:\\Program...*/], 674, ::STRINGS[40/*"Raise"*/]);
        return;
    }
...
// public generated RaiseEvent New() [static] :662
...
// private sealed class Bundle.ReadClosure :579
// {
...
// public ReadClosure(string filename) [instance] :583
...
// public string Invoke() [instance] :588
...
// public ReadClosure New(string filename) [static] :583
...
// public sealed class UserEvents :684
// {
...
// public UserEvents() :687
void UserEvents__ctor_2_fn(UserEvents* __this)
{
    __this->ctor_2();
}

// public UserEvents New() :687
void UserEvents__New2_fn(UserEvents** __retval)
{
    *__retval = UserEvents::New2();
}

// public static object Raise(Fuse.Scripting.Context context, object[] args) :700
...
// public UserEvents() [instance] :687
...
// public UserEvents New() [static] :687
...
// public static object Raise(Fuse.Scripting.Context context, object[] args) [static] :700
uObject* UserEvents::Raise(::g::Fuse::Scripting::Context* context, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::Deprecated(::STRINGS[43/*"The FuseJS/...*/], context, ::STRINGS[39/*"C:\\Program...*/], 705, ::STRINGS[40/*"Raise"*/]);
