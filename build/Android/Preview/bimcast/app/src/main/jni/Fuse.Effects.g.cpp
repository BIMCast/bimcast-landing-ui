...
// C:\ProgramData\Uno\Packages\Fuse.Effects\0.35.12\$.uno
// ------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Elements\0.35.12\Effects\$.uno
// ---------------------------------------------------------------
...
{
    ::TYPES[2] = ::g::Uno::Action1_typeof()->MakeType(Effect_typeof());
    type->SetFields(1,
...
void Effect::add_RenderBoundsChanged(uDelegate* value)
{
    ...
    RenderBoundsChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(RenderBoundsChanged1, value), ::TYPES[2/*Uno.Action<Fuse.Effects.Effect>*/]);
}
...
void Effect::remove_RenderBoundsChanged(uDelegate* value)
{
    ...
    RenderBoundsChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(RenderBoundsChanged1, value), ::TYPES[2/*Uno.Action<Fuse.Effects.Effect>*/]);
}
...
void Effect::add_RenderingChanged(uDelegate* value)
{
    ...
    RenderingChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(RenderingChanged1, value), ::TYPES[2/*Uno.Action<Fuse.Effects.Effect>*/]);
}
...
void Effect::remove_RenderingChanged(uDelegate* value)
{
    ...
    RenderingChanged1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(RenderingChanged1, value), ::TYPES[2/*Uno.Action<Fuse.Effects.Effect>*/]);
}
...
static void EffectHelpers_build(uType* type)
{
    ...
    ::TYPES[1] = ::g::Uno::Float2_typeof()->Array();
    ::TYPES[4] = ::g::Uno::UShort_typeof()->Array();
    type->SetFields(0,
...
void EffectHelpers::GaussianBlurSeparable(::g::Uno::Graphics::Texture2D* tex, ::g::Uno::Float2 dir, float sigma, int samples)
{
    ...
    uArray* weights = uArray::New(::TYPES[3/*float[]*/], 1 + samples);
...
void EffectHelpers::init_DrawCalls()
{
    ...
    uArray* Indices_304ecdb6_2_3_1 = uArray::Init<int>(::TYPES[4/*ushort[]*/], 6, 0, 1, 2, 2, 3, 0);
