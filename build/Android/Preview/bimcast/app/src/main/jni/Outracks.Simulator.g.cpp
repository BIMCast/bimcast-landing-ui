...
static void Application_build(uType* type)
{
    ...
    ::TYPES[3] = ::g::Uno::Collections::List_typeof()->MakeType(Application__DiagnosticItem_typeof());
    ::TYPES[4] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Input::PointerPressedArgs_typeof());
    ::TYPES[5] = ::g::Outracks::Simulator::ConcurrentQueue_typeof()->MakeType(::g::Uno::Exception_typeof());
    ::TYPES[6] = ::g::Fuse::UnhandledExceptionHandler_typeof();
    ::TYPES[7] = ::g::Uno::Action_typeof();
    ::TYPES[8] = ::g::Fuse::Input::IPointerEventResponder_typeof();
    ::TYPES[9] = ::g::Outracks::Simulator::Faulted_typeof();
    ::TYPES[10] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[11] = ::g::Uno::Exception_typeof();
    ::TYPES[12] = ::g::Fuse::DiagnosticHandler_typeof();
...
// public void OnPointerReleased(Fuse.Input.PointerReleasedArgs args) :228
...
// public void OnPointerWheelMoved(Fuse.Input.PointerWheelMovedArgs args) :242
...
// private void OnUnhandledException(object sender, Fuse.UnhandledExceptionArgs args) :252
...
// protected override sealed void OnUpdate() :258
void Application__OnUpdate_fn(Application* __this)
{
    ...
    if (exception != NULL)
    {
        if (uIs((::g::Outracks::Simulator::State*)__this->_state, ::TYPES[9/*Outracks.Simulator.Faulted*/]))
        {
            ::g::Uno::Diagnostics::Debug::Log5(uPtr(exception)->Message(), 1, ::STRINGS[9/*"C:\\Program...*/], 269);
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[10/*"Failure sta...*/], 1, ::STRINGS[9/*"C:\\Program...*/], 270);
        }
        else
        {
...
void Application::ctor_3(uArray* proxyEndpoints, uString* project, uDelegate* projectBundle, uArray* defines)
{
    ...
    _prevDiagnostics = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[3/*Uno.Collections.List<Outracks.Simulator.Application.DiagnosticItem>*/]));
    pointers = ((::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[4/*Uno.Collections.List<Fuse.Input.PointerPressedArgs>*/]));
    _exception = ((::g::Outracks::Simulator::ConcurrentQueue*)::g::Outracks::Simulator::ConcurrentQueue::New1(::TYPES[5/*Outracks.Simulator.ConcurrentQueue<Uno.Exception>*/]));
    ctor_2();
    ...
    add_UnhandledException(uDelegate::New(::TYPES[6/*Fuse.UnhandledExceptionHandler*/], (void*)Application__OnUnhandledException1_fn, this));
...
// private void DisplayDiagnostic(Fuse.Diagnostic d) [instance] :109
void Application::DisplayDiagnostic(::g::Fuse::Diagnostic* d)
{
    ...
    t->add_Dismissed(uDelegate::New(::TYPES[7/*Uno.Action*/], (void*)::g::Fuse::Toast__Dismiss_fn, uPtr(toast)));
}

// private void DoNothing() [instance] :219
void Application::DoNothing()
{
}

// private void InvalidateSelection(object sender, Uno.EventArgs args) [instance] :155
...
// private void OnDiagnosticReported(Fuse.Diagnostic d) [instance] :81
...
// public void OnPointerMoved(Fuse.Input.PointerMovedArgs args) [instance] :221
...
// public void OnPointerPressed(Fuse.Input.PointerPressedArgs args) [instance] :189
void Application::OnPointerPressed(::g::Fuse::Input::PointerPressedArgs* args)
{
    ...
    if (uPtr(pointers)->Count() == 3)
        ::g::Fuse::Timer::Wait(1.0, uDelegate::New(::TYPES[7/*Uno.Action*/], (void*)Application__ShowDeveloperMenu_fn, this));
...
// public void OnPointerReleased(Fuse.Input.PointerReleasedArgs args) [instance] :228
...
// public void OnPointerWheelMoved(Fuse.Input.PointerWheelMovedArgs args) [instance] :242
...
// private void OnUnhandledException(object sender, Fuse.UnhandledExceptionArgs args) [instance] :252
...
// private void ResetEverything(bool initial) [instance] :160
void Application::ResetEverything(bool initial)
{
    uStackFrame __("Outracks.Simulator.Application", "ResetEverything(bool)");
    ::g::Outracks::Simulator::FakeApp* fakeApp = ::g::Outracks::Simulator::FakeApp::New4(this);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(fakeApp->Children1()), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), ::g::Fuse::Controls::Panel::New3());
    ...
    try
    {
        ::g::Uno::Collections::ICollection::Clear(uInterface(uPtr(Children()), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]));
    }
    catch (const uThrowable& __t)
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Fuse::Diagnostics::UnknownException(::STRINGS[11/*"Failed to p...*/], e, this, ::STRINGS[9/*"C:\\Program...*/], 176, ::STRINGS[12/*"ResetEveryt...*/]);
    }

    RootHandlers();
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Children()), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), fakeApp);
}

// private void RootHandlers() [instance] :48
void Application::RootHandlers()
{
    uStackFrame __("Outracks.Simulator.Application", "RootHandlers()");
    ::g::Fuse::Diagnostics::add_DiagnosticReported(uDelegate::New(::TYPES[12/*Fuse.DiagnosticHandler*/], (void*)Application__OnDiagnosticReported_fn, this));
    ::g::Fuse::Preview::SelectionManager::add_SelectionChanged(uDelegate::New(::TYPES[13/*Uno.EventHandler<Uno.EventArgs>*/], (void*)Application__InvalidateSelection1_fn, this));
}

// private void SetState(Outracks.Simulator.State nextState) [instance] :283
...
// private void ShowDeveloperMenu() [instance] :202
void Application::ShowDeveloperMenu()
{
    ...
    for (int i = 0; i < uPtr(pointers)->Count(); i++)
        if (uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(pointers), uCRef<int>(i), &ret6), ret6))->TryHardCapture(this, uDelegate::New(::TYPES[7/*Uno.Action*/], (void*)Application__DoNothing_fn, this), NULL))
            uPtr((::g::Uno::Collections::List__get_Item_fn(uPtr(pointers), uCRef<int>(i), &ret7), ret7))->ReleaseHardCapture(this);

    if (!(::g::Uno::Collections::ICollection::Contains_ex(uInterface(uPtr(Children()), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), _developerMenu, &ret8), ret8))
        ::g::Uno::Collections::IList::Insert_ex(uInterface(uPtr(Children()), ::TYPES[14/*Uno.Collections.IList<Fuse.Node>*/]), uCRef<int>(0), _developerMenu);
}

// private void UnrootHandlers() [instance] :54
void Application::UnrootHandlers()
{
    uStackFrame __("Outracks.Simulator.Application", "UnrootHandlers()");
    ::g::Fuse::Diagnostics::remove_DiagnosticReported(uDelegate::New(::TYPES[12/*Fuse.DiagnosticHandler*/], (void*)Application__OnDiagnosticReported_fn, this));
    ::g::Fuse::Preview::SelectionManager::remove_SelectionChanged(uDelegate::New(::TYPES[13/*Uno.EventHandler<Uno.EventArgs>*/], (void*)Application__InvalidateSelection1_fn, this));
}
...
// public sealed class ArrayStream :1152
// {
static void ArrayStream_build(uType* type)
{
    ::TYPES[15] = ::g::Uno::Byte_typeof()->Array();
    ::TYPES[16] = ::g::Uno::Array_typeof()->MakeMethod(1, ::g::Uno::Byte_typeof());
    type->SetInterfaces(
...
// public override sealed bool get_CanSeek() :1171
...
// public override sealed bool get_CanTimeout() :1176
...
// public override sealed bool get_CanWrite() :1166
...
// public ArrayStream New(byte[] buffer) :1197
void ArrayStream__New1_fn(uArray* buffer, ArrayStream** __retval)
{
    *__retval = ArrayStream::New1(buffer);
}

// public generated override sealed long get_Position() :1195
...
// public generated override sealed void set_Position(long value) :1195
...
// public override sealed int Read(byte[] dst, int byteOffset, int byteCount) :1217
...
// private void ResizeTo(int newSize) :1261
void ArrayStream__ResizeTo_fn(ArrayStream* __this, int* newSize)
{
    __this->ResizeTo(*newSize);
}

// public override sealed long Seek(long byteOffset, Uno.IO.SeekOrigin origin) :1228
...
// public override sealed void SetLength(long value) :1274
...
// public override sealed void Write(byte[] src, int byteOffset, int byteCount) :1203
...
// public int get_Capacity() [instance] :1189
...
// private void EnsureCapacity(int byteCount) [instance] :1245
...
// public byte[] GetBuffer() [instance] :1269
...
// private void ResizeTo(int newSize) [instance] :1261
void ArrayStream::ResizeTo(int newSize)
{
    uStackFrame __("Outracks.Simulator.ArrayStream", "ResizeTo(int)");
    uArray* newBuffer = uArray::New(::TYPES[15/*byte[]*/], newSize);
    ::g::Uno::Array::Copy1(::TYPES[16/*Uno.Array.Copy<byte>*/], _buffer, newBuffer, uPtr(_buffer)->Length());
    _buffer = newBuffer;
    _nextIncrease = Capacity();
}

// public ArrayStream New(byte[] buffer) [static] :1197
...
// public static class Bundle :2258
// {
static void Bundle_build(uType* type)
{
    ::TYPES[17] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof());
    ::TYPES[1] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[18] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::IO::BundleFile_typeof());
    type->Reflection.SetFunctions(1,
...
// public static extern void AddOrUpdateFile(string projectRelativeFilePath, byte[] data) :2261
...
// public static extern void AddOrUpdateFile(string projectRelativeFilePath, byte[] data) [static] :2261
void Bundle::AddOrUpdateFile(uString* projectRelativeFilePath, uArray* data)
{
    ...
    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(uPtr(bundle)->Files()), ::TYPES[17/*Uno.Collections.IEnumerable<Uno.IO.BundleFile>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[1/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Uno::IO::BundleFile* exisitingFile = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[18/*Uno.Collections.IEnumerator<Uno.IO.BundleFile>*/]), &ret2), ret2);
...
// public static class BytecodeCache :1647
// {
static void BytecodeCache_build(uType* type)
{
    ...
    ::TYPES[11] = ::g::Uno::Exception_typeof();
    ::TYPES[20] = ::g::Outracks::Simulator::Bytecode::Optional_typeof()->MakeMethod(1, ::g::Outracks::Simulator::Protocol::Reify_typeof());
    ::TYPES[21] = ::g::Outracks::Simulator::Bytecode::Optional1_typeof()->MakeType(::g::Outracks::Simulator::Protocol::Reify_typeof());
...
// public static void TrySave(Outracks.Simulator.Protocol.Reify reify) :1650
void BytecodeCache__TrySave_fn(::g::Outracks::Simulator::Protocol::Reify* reify)
{
    BytecodeCache::TrySave(reify);
}

// private static Outracks.Simulator.Protocol.Reify Load() [static] :1686
::g::Outracks::Simulator::Protocol::Reify* BytecodeCache::Load()
{
...

    {
        ...
        {
            ::g::Uno::IDisposable::Dispose(uInterface(uPtr((uObject*)reader), ::TYPES[19/*Uno.IDisposable*/]));
        };
...
// private static void Save(Outracks.Simulator.Protocol.Reify reify) [static] :1662
void BytecodeCache::Save(::g::Outracks::Simulator::Protocol::Reify* reify)
{
...

    {
        const auto __finally_fun = [&]()
        {
            ::g::Uno::IDisposable::Dispose(uInterface(uPtr((uObject*)writer), ::TYPES[19/*Uno.IDisposable*/]));
        };
...
// public static Outracks.Simulator.Bytecode.Optional<Outracks.Simulator.Protocol.Reify> TryLoad() [static] :1674
::g::Outracks::Simulator::Bytecode::Optional1<uStrong< ::g::Outracks::Simulator::Protocol::Reify*> > BytecodeCache::TryLoad()
{
    ...
    try
    {
        return (::g::Outracks::Simulator::Bytecode::Optional__Some_fn(::TYPES[20/*Outracks.Simulator.Bytecode.Optional.Some<Outracks.Simulator.Protocol.Reify>*/], BytecodeCache::Load(), &ret1), ret1);
    }
    catch (const uThrowable& __t)
    {
        ::g::Uno::Exception* _ = __t.Exception;
        return (::g::Outracks::Simulator::Bytecode::Optional1__op_Implicit_fn(::TYPES[21/*Outracks.Simulator.Bytecode.Optional<Outracks.Simulator.Protocol.Reify>*/], ::g::Outracks::Simulator::Bytecode::Optional::None(), &ret2), ret2);
    }
}

// public static void TrySave(Outracks.Simulator.Protocol.Reify reify) [static] :1650
...
// private static string get_CacheFileName() [static] :1708
...
// private static string get_CachePath() [static] :1698
...
// private static string get_FuseDataDirectory() [static] :1703
...
// private static uint get_ProjectHash() [static] :1713
...
// internal sealed class ChangeIp :765
// {
static void ChangeIp_build(uType* type)
{
    ...
    ::STRINGS[20] = uString::Const("\n"
        "E.g. '192.168.1.1'");
    ::TYPES[22] = ::g::Uno::Net::IPEndPoint_typeof()->Array();
    type->SetFields(5);
}
...
// public override sealed Outracks.Simulator.State OnException(Uno.Exception e) :786
...
// protected override sealed Outracks.Simulator.State OnOk(string input) :772
void ChangeIp__OnOk_fn(ChangeIp* __this, uString* input, ::g::Outracks::Simulator::State** __retval)
{
    ...
    uArray* endpoints = uArray::Init< ::g::Uno::Net::IPEndPoint*>(::TYPES[22/*Uno.Net.IPEndPoint[]*/], 1, (::g::Uno::Net::IPEndPoint*)::g::Uno::Net::IPEndPoint::New1(::g::Uno::Net::IPAddress::Parse(input), uPtr(uPtr(::g::Outracks::Simulator::Context::ProxyEndpoints())->Strong< ::g::Uno::Net::IPEndPoint*>(0))->Port()));
    return *__retval = ::g::Outracks::Simulator::ConnectingToProxy::New2(endpoints), void();
}

// public ChangeIp([string body]) [instance] :767
...
// public ChangeIp New([string body]) [static] :767
...
{
    ::TYPES[7] = ::g::Uno::Action_typeof();
    ::TYPES[23] = ::g::Outracks::Simulator::Apply_typeof();
    ::TYPES[24] = ::g::Uno::Action1_typeof();
    ::TYPES[25] = ::g::Outracks::Simulator::ApplyFirst_typeof();
    ::TYPES[26] = ::g::Outracks::Simulator::ApplySecond_typeof();
    ::TYPES[27] = ::g::Uno::Action2_typeof();
    ::TYPES[28] = ::g::Outracks::Simulator::ForgetAction_typeof();
    ::TYPES[29] = ::g::Uno::Func1_typeof();
    ::TYPES[30] = ::g::Outracks::Simulator::Forget_typeof();
    ::TYPES[31] = ::g::Uno::EventHandler_typeof();
    ::TYPES[32] = ::g::Outracks::Simulator::ForgetAction_typeof()->MakeType(uObject_typeof(), ::g::Uno::EventArgs_typeof());
    type->SetPrecalc(
...
uDelegate* Closure::ToEventHandler(uDelegate* action)
{
    ...
    return uDelegate::New(::TYPES[31/*Uno.EventHandler*/], (void*)::g::Outracks::Simulator::ForgetAction__Execute_fn, (::g::Outracks::Simulator::ForgetAction*)::g::Outracks::Simulator::ForgetAction::New1(::TYPES[32/*Outracks.Simulator.ForgetAction<object, Uno.EventArgs>*/], action));
}
// }
...
// private sealed class EnumerableHitTestExtension.CollectHitNodesClosure :2147
// {
...
// public CollectHitNodesClosure(Uno.Collections.List<Fuse.Visual> nodes) :2151
...
// public void HitTestCallback(Fuse.HitTestResult result) :2156
...
// public CollectHitNodesClosure New(Uno.Collections.List<Fuse.Visual> nodes) :2151
...
// public CollectHitNodesClosure(Uno.Collections.List<Fuse.Visual> nodes) [instance] :2151
...
// public void HitTestCallback(Fuse.HitTestResult result) [instance] :2156
...
// public CollectHitNodesClosure New(Uno.Collections.List<Fuse.Visual> nodes) [static] :2151
...
{
    ::TYPES[33] = ::g::Uno::Collections::Queue_typeof();
    type->SetPrecalc(
...
// internal abstract class Connected :448
// {
static void Connected_build(uType* type)
{
    ::TYPES[34] = uObject_typeof()->Array();
    ::TYPES[35] = ::g::Outracks::Simulator::ISimulatorClient_typeof();
    ::TYPES[36] = ::g::Outracks::Simulator::Protocol::MessageToClient_typeof()->MakeMethod(1, ::g::Outracks::Simulator::State_typeof());
    ::TYPES[37] = ::g::Uno::Func1_typeof()->MakeType(::g::Outracks::Simulator::Protocol::Reify_typeof(), ::g::Outracks::Simulator::State_typeof());
    ::TYPES[38] = ::g::Uno::Func1_typeof()->MakeType(::g::Outracks::Simulator::Protocol::Execute_typeof(), ::g::Outracks::Simulator::State_typeof());
    ::TYPES[39] = ::g::Uno::Func1_typeof()->MakeType(::g::Outracks::Simulator::Protocol::Error_typeof(), ::g::Outracks::Simulator::State_typeof());
    type->SetFields(0,
...
// protected Connected(Outracks.Simulator.ISimulatorClient client) :452
void Connected__ctor_1_fn(Connected* __this, uObject* client)
{
    __this->ctor_1(client);
}

// protected Outracks.Simulator.State OnConnectionError(Outracks.Simulator.Protocol.Error error) :502
...
// public override Outracks.Simulator.State OnEnterState() :458
...
// public override sealed Outracks.Simulator.State OnException(Uno.Exception e) :464
...
// protected Outracks.Simulator.State OnExecute(Outracks.Simulator.Protocol.Execute args) :496
...
// protected Outracks.Simulator.State OnReify(Outracks.Simulator.Protocol.Reify reify) :491
...
// public override Outracks.Simulator.State OnUpdate() :474
void Connected__OnUpdate_fn(Connected* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    while ((::g::Outracks::Simulator::ConcurrentQueue__TryDequeue_fn(uPtr(::g::Outracks::Simulator::ISimulatorClient::IncommingMessages(uInterface(uPtr(__this->Client), ::TYPES[35/*Outracks.Simulator.ISimulatorClient*/]))), (void**)(&message), &ret2), ret2))
    {
        ::g::Outracks::Simulator::State* newState = (::g::Outracks::Simulator::Protocol::MessageToClient__Match1_fn(uPtr(message), ::TYPES[36/*Outracks.Simulator.Protocol.MessageToClient.Match<Outracks.Simulator.State>*/], uDelegate::New(::TYPES[37/*Uno.Func<Outracks.Simulator.Protocol.Reify, Outracks.Simulator.State>*/], (void*)Connected__OnReify_fn, __this), uDelegate::New(::TYPES[38/*Uno.Func<Outracks.Simulator.Protocol.Execute, Outracks.Simulator.State>*/], (void*)Connected__OnExecute_fn, __this), uDelegate::New(::TYPES[39/*Uno.Func<Outracks.Simulator.Protocol.Error, Outracks.Simulator.State>*/], (void*)Connected__OnConnectionError_fn, __this), &ret3), ret3);
...
// protected Connected(Outracks.Simulator.ISimulatorClient client) [instance] :452
...
// protected Outracks.Simulator.State OnConnectionError(Outracks.Simulator.Protocol.Error error) [instance] :502
...
// protected Outracks.Simulator.State OnExecute(Outracks.Simulator.Protocol.Execute args) [instance] :496
::g::Outracks::Simulator::State* Connected::OnExecute(::g::Outracks::Simulator::Protocol::Execute* args)
{
    ...
    ::g::Outracks::Simulator::Runtime::VirtualMachine::Execute(uPtr(args)->Function, uArray::New(::TYPES[34/*object[]*/], 0));
    return this;
}

// protected Outracks.Simulator.State OnReify(Outracks.Simulator.Protocol.Reify reify) [instance] :491
...
// internal abstract class Connecting :360
// {
...
// protected generated Connecting() :360
void Connecting__ctor_1_fn(Connecting* __this)
{
    __this->ctor_1();
}

// public override sealed Outracks.Simulator.State OnException(Uno.Exception e) :362
...
// protected generated Connecting() [instance] :360
...
// internal sealed class ConnectingToHost :407
// {
static void ConnectingToHost_build(uType* type)
{
    ...
    ::TYPES[40] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Uno::Net::IPEndPoint_typeof());
    ::TYPES[41] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof());
    ::TYPES[7] = ::g::Uno::Action_typeof();
    type->SetFields(0,
...
// public ConnectingToHost(Uno.Collections.IEnumerable<Uno.Net.IPEndPoint> simulatorEndpoints) :411
void ConnectingToHost__ctor_2_fn(ConnectingToHost* __this, uObject* simulatorEndpoints)
{
    __this->ctor_2(simulatorEndpoints);
}

// public ConnectingToHost New(Uno.Collections.IEnumerable<Uno.Net.IPEndPoint> simulatorEndpoints) :411
...
// public override sealed Outracks.Simulator.State OnEnterState() :418
void ConnectingToHost__OnEnterState_fn(ConnectingToHost* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    __this->_connecting = ::g::Outracks::Simulator::ConnectToFirstRespondingEndpoint::Execute((uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[41/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Uno.Net.IPEndPoint>*/], __this->_simulatorEndpoints)));
    ::g::Outracks::Simulator::LoadingScreen::Show(::g::Outracks::Simulator::Context::App(), ::STRINGS[21/*"Connecting"*/], ::STRINGS[22/*"Fetching pr...*/]);
    return *__retval = __this, void();
}

// public override sealed Outracks.Simulator.State OnUpdate() :433
void ConnectingToHost__OnUpdate_fn(ConnectingToHost* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    if (uPtr(__this->_connecting)->IsCompleted())
    {
        ...
        uPtr(uPtr(::g::Fuse::AppBase::Current1())->Window())->add_Closed(::g::Outracks::Simulator::Closure::ToEventHandler(uDelegate::New(::TYPES[7/*Uno.Action*/], (void*)::g::Outracks::Simulator::SimulatorClient__Dispose_fn, client)));
...
// public ConnectingToHost(Uno.Collections.IEnumerable<Uno.Net.IPEndPoint> simulatorEndpoints) [instance] :411
void ConnectingToHost::ctor_2(uObject* simulatorEndpoints)
{
    ...
    ctor_1();
    _simulatorEndpoints = ((uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[40/*Uno.Collections.EnumerableExtensions.ToArray<Uno.Net.IPEndPoint>*/], simulatorEndpoints));
}

// public ConnectingToHost New(Uno.Collections.IEnumerable<Uno.Net.IPEndPoint> simulatorEndpoints) [static] :411
...
// internal sealed class ConnectingToProxy :369
// {
static void ConnectingToProxy_build(uType* type)
{
    ...
    ::TYPES[41] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof());
    ::TYPES[42] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Uno::String_typeof());
    type->SetFields(0,
...
// public override sealed Outracks.Simulator.State OnEnterState() :384
void ConnectingToProxy__OnEnterState_fn(ConnectingToProxy* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    __this->_connecting = ::g::Outracks::Simulator::ProxyClient::GetSimulatorEndpoint((uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[41/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Uno.Net.IPEndPoint>*/], __this->_proxyEndpoints)), ::g::Outracks::Simulator::Context::Project(), (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[42/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<string>*/], ::g::Outracks::Simulator::Context::Defines())));
    ::g::Outracks::Simulator::LoadingScreen::Show(::g::Outracks::Simulator::Context::App(), ::STRINGS[21/*"Connecting"*/], ::STRINGS[23/*"Connecting ...*/]);
    return *__retval = __this, void();
}

// public override sealed Outracks.Simulator.State OnUpdate() :398
void ConnectingToProxy__OnUpdate_fn(ConnectingToProxy* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    if (uPtr(__this->_connecting)->IsCompleted())
        return *__retval = ::g::Outracks::Simulator::ConnectingToHost::New1((uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[41/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<Uno.Net.IPEndPoint>*/], (::g::Outracks::Simulator::Task__get_Result_fn(uPtr(__this->_connecting), &ret3), ret3)))), void();

    return *__retval = __this, void();
}

// public ConnectingToProxy() [instance] :379
...
// public ConnectingToProxy(Uno.Net.IPEndPoint[] proxyEndpoints) [instance] :374
...
// public ConnectingToProxy New() [static] :379
...
// public ConnectingToProxy New(Uno.Net.IPEndPoint[] proxyEndpoints) [static] :374
...
// internal sealed class ConnectionLost :735
// {
static void ConnectionLost_build(uType* type)
{
    ...
    ::TYPES[43] = ::g::Outracks::Simulator::DialogButton_typeof()->Array();
    type->SetFields(5);
}
...
// public ConnectionLost(Outracks.Simulator.Protocol.ExceptionInfo exception) :741
...
// public ConnectionLost(Uno.Exception exception) :737
void ConnectionLost__ctor_3_fn(ConnectionLost* __this, ::g::Uno::Exception* exception)
{
    __this->ctor_3(exception);
}

// public ConnectionLost New(Outracks.Simulator.Protocol.ExceptionInfo exception) :741
...
// public ConnectionLost New(Uno.Exception exception) :737
void ConnectionLost__New3_fn(::g::Uno::Exception* exception, ConnectionLost** __retval)
{
    *__retval = ConnectionLost::New3(exception);
}

// public ConnectionLost(Outracks.Simulator.Protocol.ExceptionInfo exception) [instance] :741
...
// public ConnectionLost New(Outracks.Simulator.Protocol.ExceptionInfo exception) [static] :741
...
// public ConnectionLost New(Uno.Exception exception) [static] :737
...
// internal sealed class ConnectToEndpointClosure :993
// {
...
// public ConnectToEndpointClosure(Uno.Net.IPEndPoint endpoint) :997
...
// public Uno.Net.Sockets.Socket Execute() :1002
...
// public ConnectToEndpointClosure New(Uno.Net.IPEndPoint endpoint) :997
...
// public ConnectToEndpointClosure(Uno.Net.IPEndPoint endpoint) [instance] :997
...
// public Uno.Net.Sockets.Socket Execute() [instance] :1002
...
// public ConnectToEndpointClosure New(Uno.Net.IPEndPoint endpoint) [static] :997
...
// public static class ConnectToFirstRespondingEndpoint :976
// {
static void ConnectToFirstRespondingEndpoint_build(uType* type)
{
    ::TYPES[44] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Outracks::Simulator::Task_typeof()->MakeType(::g::Uno::Net::Sockets::Socket_typeof()));
    ::TYPES[45] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof());
    ::TYPES[1] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[46] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof());
    ::TYPES[47] = ::g::Outracks::Simulator::Tasks_typeof()->MakeMethod(1, ::g::Uno::Net::Sockets::Socket_typeof());
    ::TYPES[48] = ::g::Uno::Func_typeof()->MakeType(::g::Uno::Net::Sockets::Socket_typeof());
    ::TYPES[49] = ::g::Outracks::Simulator::Tasks_typeof()->MakeMethod(1, ::g::Uno::Net::Sockets::Socket_typeof());
    ::TYPES[50] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Exception_typeof()), ::g::Uno::Net::Sockets::Socket_typeof());
    type->Reflection.SetFunctions(1,
...
// public static Outracks.Simulator.Task<Uno.Net.Sockets.Socket> Execute(Uno.Collections.IEnumerable<Uno.Net.IPEndPoint> simulatorEndpoints) :978
...
// private static Uno.Net.Sockets.Socket OnNoResult(Uno.Collections.IEnumerable<Uno.Exception> exceptions) :987
...
// public static Outracks.Simulator.Task<Uno.Net.Sockets.Socket> Execute(Uno.Collections.IEnumerable<Uno.Net.IPEndPoint> simulatorEndpoints) [static] :978
::g::Outracks::Simulator::Task* ConnectToFirstRespondingEndpoint::Execute(uObject* simulatorEndpoints)
{
    ...
    ::g::Uno::Collections::List* socketTasks = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[44/*Uno.Collections.List<Outracks.Simulator.Task<Uno.Net.Sockets.Socket>>*/]);
    ...
    {
        ::g::Uno::Net::IPEndPoint* endpoint = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[46/*Uno.Collections.IEnumerator<Uno.Net.IPEndPoint>*/]), &ret2), ret2);
        ::g::Uno::Collections::List__Add_fn(uPtr(socketTasks), (::g::Outracks::Simulator::Task*)::g::Outracks::Simulator::Tasks::Run(::TYPES[47/*Outracks.Simulator.Tasks.Run<Uno.Net.Sockets.Socket>*/], uDelegate::New(::TYPES[48/*Uno.Func<Uno.Net.Sockets.Socket>*/], (void*)::g::Outracks::Simulator::ConnectToEndpointClosure__Execute_fn, ::g::Outracks::Simulator::ConnectToEndpointClosure::New1(endpoint))));
    }

    return (::g::Outracks::Simulator::Task*)::g::Outracks::Simulator::Tasks::WaitForFirstResult(::TYPES[49/*Outracks.Simulator.Tasks.WaitForFirstResult<Uno.Net.Sockets.Socket>*/], (uObject*)socketTasks, uDelegate::New(::TYPES[50/*Uno.Func<Uno.Collections.IEnumerable<Uno.Exception>, Uno.Net.Sockets.Socket>*/], (void*)ConnectToFirstRespondingEndpoint__OnNoResult_fn));
}

// private static Uno.Net.Sockets.Socket OnNoResult(Uno.Collections.IEnumerable<Uno.Exception> exceptions) [static] :987
...
// public static class Context :1829
// {
...
// public static generated Outracks.Simulator.FakeApp get_App() :1832
void Context__get_App_fn(::g::Outracks::Simulator::FakeApp** __retval)
{
    *__retval = Context::App();
}

// private static generated void set_App(Outracks.Simulator.FakeApp value) :1832
void Context__set_App_fn(::g::Outracks::Simulator::FakeApp* value)
{
    Context::App(value);
}

// public static generated string[] get_Defines() :1835
void Context__get_Defines_fn(uArray** __retval)
{
    *__retval = Context::Defines();
}

// private static generated void set_Defines(string[] value) :1835
void Context__set_Defines_fn(uArray* value)
{
    Context::Defines(value);
}

// public static generated Outracks.Simulator.InputMode get_InputMode() :1831
void Context__get_InputMode_fn(int* __retval)
{
    *__retval = Context::InputMode();
}

// private static generated void set_InputMode(Outracks.Simulator.InputMode value) :1831
void Context__set_InputMode_fn(int* value)
{
    Context::InputMode(*value);
}

// public static generated string get_Project() :1834
void Context__get_Project_fn(uString** __retval)
{
    *__retval = Context::Project();
}

// private static generated void set_Project(string value) :1834
void Context__set_Project_fn(uString* value)
{
    Context::Project(value);
}

// public static Uno.IO.Bundle get_ProjectBundle() :1840
void Context__get_ProjectBundle_fn(::g::Uno::IO::Bundle** __retval)
{
    *__retval = Context::ProjectBundle();
}

// public static generated Uno.Net.IPEndPoint[] get_ProxyEndpoints() :1833
void Context__get_ProxyEndpoints_fn(uArray** __retval)
{
    *__retval = Context::ProxyEndpoints();
}

// private static generated void set_ProxyEndpoints(Uno.Net.IPEndPoint[] value) :1833
void Context__set_ProxyEndpoints_fn(uArray* value)
{
    Context::ProxyEndpoints(value);
}

// public static generated Outracks.Simulator.Runtime.IReflection get_Reflection() :1843
void Context__get_Reflection_fn(uObject** __retval)
{
    *__retval = Context::Reflection();
}

// public static generated void set_Reflection(Outracks.Simulator.Runtime.IReflection value) :1843
void Context__set_Reflection_fn(uObject* value)
{
    Context::Reflection(value);
}

// public static void SetApp(Outracks.Simulator.FakeApp app) :1861
void Context__SetApp_fn(::g::Outracks::Simulator::FakeApp* app)
{
    Context::SetApp(app);
}

// public static void SetDesignMode() :1845
void Context__SetDesignMode_fn()
{
    Context::SetDesignMode();
}

// public static void SetGlobals(Uno.Net.IPEndPoint[] proxyEndpoints, string project, Uno.Func<Uno.IO.Bundle> projectBundle, string[] defines) :1866
...
// public static void SetInteractiveMode() :1853
...
// public static void SetApp(Outracks.Simulator.FakeApp app) [static] :1861
...
// public static void SetDesignMode() [static] :1845
...
// public static void SetGlobals(Uno.Net.IPEndPoint[] proxyEndpoints, string project, Uno.Func<Uno.IO.Bundle> projectBundle, string[] defines) [static] :1866
...
// public static void SetInteractiveMode() [static] :1853
...
// public static generated Outracks.Simulator.FakeApp get_App() [static] :1832
...
// private static generated void set_App(Outracks.Simulator.FakeApp value) [static] :1832
...
// public static generated string[] get_Defines() [static] :1835
...
// private static generated void set_Defines(string[] value) [static] :1835
...
// public static generated Outracks.Simulator.InputMode get_InputMode() [static] :1831
...
// private static generated void set_InputMode(Outracks.Simulator.InputMode value) [static] :1831
...
// public static generated string get_Project() [static] :1834
...
// private static generated void set_Project(string value) [static] :1834
...
// public static Uno.IO.Bundle get_ProjectBundle() [static] :1840
...
// public static generated Uno.Net.IPEndPoint[] get_ProxyEndpoints() [static] :1833
...
// private static generated void set_ProxyEndpoints(Uno.Net.IPEndPoint[] value) [static] :1833
...
// public static generated Outracks.Simulator.Runtime.IReflection get_Reflection() [static] :1843
...
// public static generated void set_Reflection(Outracks.Simulator.Runtime.IReflection value) [static] :1843
...
// public partial sealed class DeveloperMenu :2311
// {
...
static void DeveloperMenu_build(uType* type)
{
    ...
    ::TYPES[51] = ::g::Fuse::Animations::Change_typeof()->MakeType(::g::Uno::Float_typeof());
    ::TYPES[52] = ::g::Fuse::Gestures::ClickedHandler_typeof();
    ::TYPES[10] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[53] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Animations::Animator_typeof());
    type->SetInterfaces(
...
// private void Close(object sender, Uno.EventArgs args) :2318
void DeveloperMenu__Close_fn(DeveloperMenu* __this, uObject* sender, ::g::Uno::EventArgs* args)
{
    __this->Close(sender, args);
}

// private void GoBack(object sender, Uno.EventArgs args) :2313
...
// private void Close(object sender, Uno.EventArgs args) [instance] :2318
...
// private void GoBack(object sender, Uno.EventArgs args) [instance] :2313
...
void DeveloperMenu::InitializeUX()
{
    ...
    ::g::Fuse::Animations::Change* temp6 = (::g::Fuse::Animations::Change*)::g::Fuse::Animations::Change::New2(::TYPES[51/*Fuse.Animations.Change<float>*/], this_Opacity_inst);
    ...
    ::g::Fuse::Animations::Change* temp9 = (::g::Fuse::Animations::Change*)::g::Fuse::Animations::Change::New2(::TYPES[51/*Fuse.Animations.Change<float>*/], this_Opacity_inst);
    ::g::Fuse::Animations::Scale* temp10 = ::g::Fuse::Animations::Scale::New2();
    Color(::g::Uno::Float4__New2(0.0f, 0.0f, 0.0f, 0.8f));
    ::g::Fuse::Gestures::Clicked::AddHandler(this, uDelegate::New(::TYPES[52/*Fuse.Gestures.ClickedHandler*/], (void*)DeveloperMenu__Close_fn, this));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp->Children()), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), temp1);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp->Children()), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), temp2);
    temp1->Text(::STRINGS[31/*"Go back"*/]);
    temp1->Alignment(5);
    temp1->Margin(::g::Uno::Float4__New2(20.0f, 20.0f, 20.0f, 20.0f));
    ::g::Fuse::Gestures::Clicked::AddHandler(temp1, uDelegate::New(::TYPES[52/*Fuse.Gestures.ClickedHandler*/], (void*)DeveloperMenu__GoBack_fn, this));
    temp2->Alignment(10);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp2->Children()), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), temp3);
    ...
    temp4->Alignment(10);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp5->Animators()), ::TYPES[53/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), temp6);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp5->Animators()), ::TYPES[53/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), temp7);
    ...
    temp7->Easing(25);
    temp7->Duration(0.3);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp8->Animators()), ::TYPES[53/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), temp9);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp8->Animators()), ::TYPES[53/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), temp10);
...
// public static extern class DeviceInfo :1753
// {
...
// public static string get_Name() [static] :1757
...
// private sealed class Application.DiagnosticItem :60
// {
...
// public generated DiagnosticItem() [instance] :60
void Application__DiagnosticItem::ctor_()
{
}

// public bool SameAs(Fuse.Diagnostic d) [instance] :66
...
// public generated DiagnosticItem New() [static] :60
...
// internal sealed class DialogButton :1617
// {
...
// public DialogButton(string text, Outracks.Simulator.State destination) :1622
...
// public DialogButton New(string text, Outracks.Simulator.State destination) :1622
...
// public DialogButton(string text, Outracks.Simulator.State destination) [instance] :1622
...
// public DialogButton New(string text, Outracks.Simulator.State destination) [static] :1622
...
// internal static class EnumerableHitTestExtension :2137
// {
static void EnumerableHitTestExtension_build(uType* type)
{
    ::TYPES[54] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Visual_typeof());
    ::TYPES[55] = ::g::Fuse::HitTestCallback_typeof();
}
...
// public static Uno.Collections.IList<Fuse.Visual> HitTest2(Fuse.Visual node, float2 windowPoint) :2139
...
// public static Uno.Collections.IList<Fuse.Visual> HitTest2(Fuse.Visual node, float2 windowPoint) [static] :2139
uObject* EnumerableHitTestExtension::HitTest2(::g::Fuse::Visual* node, ::g::Uno::Float2 windowPoint)
{
    ...
    ::g::Uno::Collections::List* nodes = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[54/*Uno.Collections.List<Fuse.Visual>*/]);
    ::g::Fuse::HitTestContext* htc = ::g::Fuse::HitTestContext::New1(windowPoint, uDelegate::New(::TYPES[55/*Fuse.HitTestCallback*/], (void*)EnumerableHitTestExtension__CollectHitNodesClosure__HitTestCallback_fn, EnumerableHitTestExtension__CollectHitNodesClosure::New1(nodes)));
...
// public partial sealed class ErrorToast :2287
// {
...
static void ErrorToast_build(uType* type)
{
    ...
    ::TYPES[56] = ::g::Fuse::Controls::PropertyBinding_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[57] = ::g::Fuse::Controls::PropertyBinding_typeof()->MakeType(::g::Uno::Bool_typeof());
    ::TYPES[51] = ::g::Fuse::Animations::Change_typeof()->MakeType(::g::Uno::Float_typeof());
    ::TYPES[58] = ::g::Fuse::Controls::PropertyBinding_typeof()->MakeType(::g::Uno::Float4_typeof());
    ::TYPES[10] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[59] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof());
    ::TYPES[52] = ::g::Fuse::Gestures::ClickedHandler_typeof();
    ::TYPES[53] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Animations::Animator_typeof());
...
// public generated void add_Dismissed(Uno.Action value) :2301
void ErrorToast__add_Dismissed_fn(ErrorToast* __this, uDelegate* value)
{
    __this->add_Dismissed(value);
}

// public generated void remove_Dismissed(Uno.Action value) :2301
...
// public generated void add_Dismissed(Uno.Action value) [instance] :2301
void ErrorToast::add_Dismissed(uDelegate* value)
{
    uStackFrame __("Outracks.Simulator.ErrorToast", "add_Dismissed(Uno.Action)");
    Dismissed1 = uCast<uDelegate*>(::g::Uno::Delegate::Combine(Dismissed1, value), ::TYPES[7/*Uno.Action*/]);
}

// public generated void remove_Dismissed(Uno.Action value) [instance] :2301
void ErrorToast::remove_Dismissed(uDelegate* value)
{
    uStackFrame __("Outracks.Simulator.ErrorToast", "remove_Dismissed(Uno.Action)");
    Dismissed1 = uCast<uDelegate*>(::g::Uno::Delegate::Remove(Dismissed1, value), ::TYPES[7/*Uno.Action*/]);
}
...
void ErrorToast::InitializeUX1()
{
    ...
    ::g::Fuse::Controls::PropertyBinding* temp5 = (::g::Fuse::Controls::PropertyBinding*)::g::Fuse::Controls::PropertyBinding::New1(::TYPES[56/*Fuse.Controls.PropertyBinding<string>*/], temp_Value_inst, this_Message_inst);
    ::g::Fuse::Controls::Text* temp6 = ::g::Fuse::Controls::Text::New3();
    ::g::Fuse::Controls::Button* temp7 = ::g::Fuse::Controls::Button::New5();
    ::g::Fuse::Controls::PropertyBinding* temp8 = (::g::Fuse::Controls::PropertyBinding*)::g::Fuse::Controls::PropertyBinding::New1(::TYPES[57/*Fuse.Controls.PropertyBinding<bool>*/], temp1_Value_inst, this_ShowMonitorInfo_inst);
    ::g::Fuse::Triggers::AddingAnimation* temp9 = ::g::Fuse::Triggers::AddingAnimation::New2();
    ::g::Fuse::Animations::Scale* temp10 = ::g::Fuse::Animations::Scale::New2();
    ::g::Fuse::Animations::Change* temp11 = (::g::Fuse::Animations::Change*)::g::Fuse::Animations::Change::New2(::TYPES[51/*Fuse.Animations.Change<float>*/], this_Opacity_inst);
    ...
    ::g::Fuse::Animations::Change* temp14 = (::g::Fuse::Animations::Change*)::g::Fuse::Animations::Change::New2(::TYPES[51/*Fuse.Animations.Change<float>*/], this_Opacity_inst);
    ::g::Fuse::Controls::PropertyBinding* temp15 = (::g::Fuse::Controls::PropertyBinding*)::g::Fuse::Controls::PropertyBinding::New1(::TYPES[58/*Fuse.Controls.PropertyBinding<float4>*/], temp2_Color_inst, this_FillColor_inst);
    ::g::Fuse::Controls::PropertyBinding* temp16 = (::g::Fuse::Controls::PropertyBinding*)::g::Fuse::Controls::PropertyBinding::New1(::TYPES[58/*Fuse.Controls.PropertyBinding<float4>*/], temp3_Color_inst, this_StrokeColor_inst);
    temp4->Width(::g::Uno::UX::Size__New1(75.0f, 4));
    temp4->Alignment(14);
    temp4->Margin(::g::Uno::Float4__New2(40.0f, 40.0f, 40.0f, 40.0f));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp4->Children()), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), temp);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp4->Children()), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), temp1);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp4->Children()), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), temp9);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp4->Children()), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), temp12);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp4->Children()), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), temp2);
    temp->TextWrapping(1);
    temp->FontSize(16.0f);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp1->Nodes()), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), temp6);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp1->Nodes()), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), temp7);
    ...
    ::g::Fuse::Gestures::Clicked::AddHandler(temp7, uDelegate::New(::TYPES[52/*Fuse.Gestures.ClickedHandler*/], (void*)ErrorToast__OnClicked_fn, this));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp9->Animators()), ::TYPES[53/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), temp10);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp9->Animators()), ::TYPES[53/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), temp11);
    temp10->Factor(0.8f);
    temp10->Easing(25);
    temp10->Duration(0.2);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp12->Animators()), ::TYPES[53/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), temp13);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp12->Animators()), ::TYPES[53/*Uno.Collections.ICollection<Fuse.Animations.Animator>*/]), temp14);
    temp13->Factor(0.8f);
    temp13->Easing(26);
    temp13->Duration(0.4);
...
// private void OnClicked(object sender, Uno.EventArgs args) [instance] :2289
...
// internal static class Exceptions :686
// {
static void Exceptions_build(uType* type)
{
    ::TYPES[35] = ::g::Outracks::Simulator::ISimulatorClient_typeof();
    ::TYPES[61] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Uno::Exception_typeof());
    ::TYPES[62] = ::g::Uno::AggregateException_typeof();
}
...
// public static void Send(Outracks.Simulator.ISimulatorClient client, Uno.Collections.List<Uno.Exception> exceptions) :688
void Exceptions__Send_fn(uObject* client, ::g::Uno::Collections::List* exceptions)
{
    Exceptions::Send(client, exceptions);
}

// public static Uno.Collections.List<Uno.Exception> Unpack(Uno.Exception e) :697
void Exceptions__Unpack_fn(::g::Uno::Exception* e, ::g::Uno::Collections::List** __retval)
{
    *__retval = Exceptions::Unpack(e);
}

// public static void Send(Outracks.Simulator.ISimulatorClient client, Uno.Collections.List<Uno.Exception> exceptions) [static] :688
...
::g::Uno::Collections::List* Exceptions::Unpack(::g::Uno::Exception* e)
{
    ...
    ::g::Uno::Exception* ret2;
    ::g::Uno::Collections::List* exceptions = (::g::Uno::Collections::List*)::g::Uno::Collections::List::New1(::TYPES[61/*Uno.Collections.List<Uno.Exception>*/]);

    if (uIs(e, ::TYPES[62/*Uno.AggregateException*/]))
    {
        ::g::Uno::AggregateException* aggregate = uCast< ::g::Uno::AggregateException*>(e, ::TYPES[62/*Uno.AggregateException*/]);
...
// internal sealed class FailedToConnect :752
// {
...
// public FailedToConnect New(Uno.Exception exception) [static] :754
...
static void FailedToConnectToProxy_build(uType* type)
{
    ::STRINGS[46] = uString::Const("Failed to connect to proxy:\n"
        "");
    ::TYPES[63] = ::g::Outracks::Simulator::List_typeof()->MakeMethod(1, ::g::Uno::Exception_typeof());
    type->SetFields(3,
...
// public sealed class FailedToConnectToSimulator :964
// {
...
// public FailedToConnectToSimulator(Uno.Collections.IEnumerable<Uno.Exception> innerExceptions) :968
void FailedToConnectToSimulator__ctor_3_fn(FailedToConnectToSimulator* __this, uObject* innerExceptions)
{
    __this->ctor_3(innerExceptions);
}

// public FailedToConnectToSimulator New(Uno.Collections.IEnumerable<Uno.Exception> innerExceptions) :968
...
// public FailedToConnectToSimulator(Uno.Collections.IEnumerable<Uno.Exception> innerExceptions) [instance] :968
...
// public FailedToConnectToSimulator New(Uno.Collections.IEnumerable<Uno.Exception> innerExceptions) [static] :968
...
// public sealed class FakeApp :1898
// {
static void FakeApp_build(uType* type)
{
    ::TYPES[64] = ::g::Outracks::Simulator::ConcurrentQueue_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[10] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[7] = ::g::Uno::Action_typeof();
    ::TYPES[65] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Fuse::Node_typeof());
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::Controls::Control_type, interface0),
        ::g::Fuse::Scripting::IScriptObject_typeof(), offsetof(::g::Fuse::Controls::Control_type, interface1),
        ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::Controls::Control_type, interface2),
...
// protected override sealed void OnRooted() :1926
void FakeApp__OnRooted_fn(FakeApp* __this)
{
    ...
    ::g::Fuse::UpdateManager::AddAction1(uDelegate::New(::TYPES[7/*Uno.Action*/], (void*)FakeApp__OnUpdate_fn, __this), 0);
}
...
void FakeApp::ctor_7(::g::Fuse::App* app)
{
    ...
    ctor_6();
    _app = app;
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Children1()), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), _overlayPlaceholde);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Children1()), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), _rootPlaceholder);
    OverlayVisible(false);
}

// private void AddNewFlashes() [instance] :1971
...
// public new float4 get_Background() [instance] :1985
...
// public new void set_Background(float4 value) [instance] :1986
...
// public new Uno.Collections.IList<Fuse.Node> get_Children() [instance] :1991
...
// public float4 get_ClearColor() [instance] :2019
...
// public void set_ClearColor(float4 value) [instance] :2020
...
// public float get_ClearDepth() [instance] :2025
...
// public void set_ClearDepth(float value) [instance] :2026
void FakeApp::ClearDepth(float value)
{
}

// public void Flash(string message) [instance] :1945
...
// private bool get_HasFlash() [instance] :1959
...
// private void OnUpdate() [instance] :1938
...
// public Fuse.Node get_Overlay() [instance] :2003
...
// public void set_Overlay(Fuse.Node value) [instance] :2004
void FakeApp::Overlay(::g::Fuse::Node* value)
{
    uStackFrame __("Outracks.Simulator.FakeApp", "set_Overlay(Fuse.Node)");
    ::g::Uno::Collections::ICollection::Clear(uInterface(uPtr(uPtr(_overlayPlaceholde)->Children()), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]));
    OverlayVisible(false);

    if (value != NULL)
    {
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(_overlayPlaceholde)->Children()), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), value);
        OverlayVisible(true);
    }
}

// private bool get_OverlayVisible() [instance] :1910
...
// private void set_OverlayVisible(bool value) [instance] :1911
...
// private void RemoveExpiredFlashes() [instance] :1962
...
// public new Uno.Collections.IList<Uno.UX.Resource> get_Resources() [instance] :1998
...
// private void UpdateFlashes() [instance] :1950
...
// public FakeApp New(Fuse.App app) [static] :1918
...
// internal sealed class Faulted :724
// {
...
// public Faulted(bool isOnline, Uno.Exception exception, Outracks.Simulator.DialogButton[] buttons) :726
...
// public Faulted New(bool isOnline, Uno.Exception exception, Outracks.Simulator.DialogButton[] buttons) :726
...
// public Faulted(bool isOnline, Uno.Exception exception, Outracks.Simulator.DialogButton[] buttons) [instance] :726
...
// public Faulted New(bool isOnline, Uno.Exception exception, Outracks.Simulator.DialogButton[] buttons) [static] :726
...
// internal sealed class Flasher :2062
// {
static void Flasher_build(uType* type)
{
    ::STRINGS[50] = uString::Const("#222");
    ::TYPES[66] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Drawing::GradientStop_typeof());
    ::TYPES[10] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[7] = ::g::Uno::Action_typeof();
    type->SetInterfaces(
        ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Binding_typeof()), offsetof(::g::Fuse::Controls::Control_type, interface0),
...
void Flasher__OnRooted_fn(Flasher* __this)
{
    ...
    ::g::Fuse::UpdateManager::AddAction1(uDelegate::New(::TYPES[7/*Uno.Action*/], (void*)Flasher__OnUpdate_fn, __this), 0);
    uPtr(__this->Background())->Pin();
}

// protected override sealed void OnUnrooted() :2092
void Flasher__OnUnrooted_fn(Flasher* __this)
{
    uStackFrame __("Outracks.Simulator.Flasher", "OnUnrooted()");
    ::g::Fuse::UpdateManager::RemoveAction1(uDelegate::New(::TYPES[7/*Uno.Action*/], (void*)Flasher__OnUpdate_fn, __this), 0);
    uPtr(__this->Background())->Unpin();
}

// private void OnUpdate() :2098
void Flasher__OnUpdate_fn(Flasher* __this)
{
    __this->OnUpdate();
}

// public Flasher(string text) [instance] :2066
void Flasher::ctor_7(uString* text)
{
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(linearGradient->Stops()), ::TYPES[66/*Uno.Collections.ICollection<Fuse.Drawing.GradientStop>*/]), ::g::Fuse::Drawing::GradientStop::New3(::g::Uno::Float4__New8((ind2 = ::g::Uno::Color::FromHex(::STRINGS[50/*"#222"*/]), ::g::Uno::Float3__New2(ind2.X, ind2.Y, ind2.Z)), 0.9f), 0.0f));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(linearGradient->Stops()), ::TYPES[66/*Uno.Collections.ICollection<Fuse.Drawing.GradientStop>*/]), ::g::Fuse::Drawing::GradientStop::New3(::g::Uno::Float4__New8((ind3 = ::g::Uno::Color::FromHex(::STRINGS[50/*"#222"*/]), ::g::Uno::Float3__New2(ind3.X, ind3.Y, ind3.Z)), 0.9f), 1.0f));
    Background(linearGradient);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(Children()), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), (collection1 = ::g::Fuse::Controls::Text::New3(), ind4 = ::g::Fuse::Font::PlatformDefault(), uPtr(collection1)->Font(ind4), ind4, uPtr(collection1)->FontSize(25.0f), 25.0f, uPtr(collection1)->Value(text), text, ind5 = ::g::Uno::Float4__New2(1.0f, 1.0f, 1.0f, 1.0f), uPtr(collection1)->TextColor(ind5), ind5, uPtr(collection1)->Alignment(10), 10, collection1));
}

// private double get_AnimationParameter() [instance] :2110
...
// public bool IsExpired() [instance] :2103
...
// private void OnUpdate() [instance] :2098
...
// public Flasher New(string text) [static] :2066
...
uArray* GetSimulatorEndpoint::Execute()
{
    ...
    try
    {
...

        {
            const auto __finally_fun = [&]()
            {
                ::g::Uno::IDisposable::Dispose(uInterface(uPtr((uObject*)stream), ::TYPES[19/*Uno.IDisposable*/]));
            };
...

            {
...

                {
                    ...
                    uArray* endpoints = uArray::New(::TYPES[22/*Uno.Net.IPEndPoint[]*/], ::g::Uno::Int::Parse(endpointCount));
...
// internal static class GoOffline :792
// {
static void GoOffline_build(uType* type)
{
    ...
    ::TYPES[71] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Outracks::Simulator::DialogButton_typeof());
}
...
// public static Outracks.Simulator.DialogButton[] PrependOption(Outracks.Simulator.DialogButton[] otherButtons) :794
void GoOffline__PrependOption_fn(uArray* otherButtons, uArray** __retval)
{
    *__retval = GoOffline::PrependOption(otherButtons);
}

// public static Outracks.Simulator.DialogButton[] PrependOption(Outracks.Simulator.DialogButton[] otherButtons) [static] :794
...
// internal sealed class Idle :509
// {
...
// public Idle(Outracks.Simulator.ISimulatorClient client) :511
void Idle__ctor_2_fn(Idle* __this, uObject* client)
{
    __this->ctor_2(client);
}

// public Idle New(Outracks.Simulator.ISimulatorClient client) :511
void Idle__New1_fn(uObject* client, Idle** __retval)
{
    *__retval = Idle::New1(client);
}

// public override sealed Outracks.Simulator.State OnEnterState() :515
void Idle__OnEnterState_fn(Idle* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    ::g::Outracks::Simulator::ISimulatorClient::Send(uInterface(uPtr(__this->Client), ::TYPES[35/*Outracks.Simulator.ISimulatorClient*/]), ::g::Outracks::Simulator::Protocol::RegisterName::New1(::g::Outracks::Simulator::DeviceInfo::GUID(), ::g::Outracks::Simulator::DeviceInfo::Name()));
    ::g::Outracks::Simulator::LoadingScreen::Show(::g::Outracks::Simulator::Context::App(), ::STRINGS[53/*"Loading"*/], ::STRINGS[54/*"Starting pr...*/]);
    return *__retval = __this, void();
}

// protected override sealed Outracks.Simulator.State OnFaulted(Uno.Exception e) :528
void Idle__OnFaulted_fn(Idle* __this, ::g::Uno::Exception* e, ::g::Outracks::Simulator::State** __retval)
{
    ...
    return *__retval = ::g::Outracks::Simulator::Faulted::New2(::g::Outracks::Simulator::ISimulatorClient::IsOnline(uInterface(uPtr(__this->Client), ::TYPES[35/*Outracks.Simulator.ISimulatorClient*/])), e, uArray::Init< ::g::Outracks::Simulator::DialogButton*>(::TYPES[43/*Outracks.Simulator.DialogButton[]*/], 1, (::g::Outracks::Simulator::DialogButton*)::g::Outracks::Simulator::DialogButton::New1(::STRINGS[44/*"Try again"*/], __this))), void();
}

// private void SendDebugLog(string text, Uno.Diagnostics.DebugMessageType type) :523
void Idle__SendDebugLog_fn(Idle* __this, uString* text, int* type)
{
    __this->SendDebugLog(text, *type);
}

// public Idle(Outracks.Simulator.ISimulatorClient client) [instance] :511
...
// private void SendDebugLog(string text, Uno.Diagnostics.DebugMessageType type) [instance] :523
void Idle::SendDebugLog(uString* text, int type)
{
    ...
    ::g::Outracks::Simulator::ISimulatorClient::Send(uInterface(uPtr(Client), ::TYPES[35/*Outracks.Simulator.ISimulatorClient*/]), ::g::Outracks::Simulator::Protocol::DebugLog::New1(::g::Outracks::Simulator::DeviceInfo::GUID(), ::g::Outracks::Simulator::DeviceInfo::Name(), text));
}

// public Idle New(Outracks.Simulator.ISimulatorClient client) [static] :511
...
static void IndentString_build(uType* type)
{
    ...
    ::TYPES[77] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(2, ::g::Uno::String_typeof(), ::g::Uno::String_typeof());
    ::TYPES[42] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[78] = ::g::Uno::Char_typeof()->Array();
    ::TYPES[79] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::String_typeof(), ::g::Uno::String_typeof());
    type->Reflection.SetFunctions(1,
...
uString* IndentString::Indent(uString* str)
{
    ...
    return ::g::Outracks::Simulator::StringSplitting::Join((uObject*)::g::Uno::Collections::EnumerableExtensions::Select(::TYPES[77/*Uno.Collections.EnumerableExtensions.Select<string, string>*/], (uObject*)((::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable*)::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable::New1(::TYPES[42/*Uno.Runtime.Implementation.Internal.ArrayEnumerable<string>*/], ::g::Uno::String::Split(uPtr(str), uArray::Init<int>(::TYPES[78/*char[]*/], 1, 10)))), uDelegate::New(::TYPES[79/*Uno.Func<string, string>*/], (void*)IndentString__PrefixWithTab_fn)), ::STRINGS[2/*"\n"*/]);
}
...
// public abstract interface ISimulatorClient :920
// {
...
// internal sealed class LoadingScreen :1303
// {
...
// public generated LoadingScreen() :1303
void LoadingScreen__ctor__fn(LoadingScreen* __this)
{
    __this->ctor_();
}

// public generated LoadingScreen New() :1303
void LoadingScreen__New1_fn(LoadingScreen** __retval)
{
    *__retval = LoadingScreen::New1();
}

// public static void Show(Outracks.Simulator.FakeApp app, string header, string message) :1305
...
// public generated LoadingScreen() [instance] :1303
void LoadingScreen::ctor_()
{
}

// public generated LoadingScreen New() [static] :1303
...
// public static void Show(Outracks.Simulator.FakeApp app, string header, string message) [static] :1305
void LoadingScreen::Show(::g::Outracks::Simulator::FakeApp* app, uString* header, uString* message)
{
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(app)->Children1()), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), (collection1 = ::g::Fuse::Controls::StackPanel::New4(), uPtr(collection1)->Alignment(10), 10, ind5 = ::g::Uno::Float4__New1(40.0f), uPtr(collection1)->Padding(ind5), ind5, array2 = uPtr(collection1)->Children(), ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array2), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), (collection3 = ::g::Fuse::Controls::Text::New3(), ind6 = ::g::Uno::Float4__New2(0.0f, 0.0f, 0.0f, 20.0f), uPtr(collection3)->Margin(ind6), ind6, uPtr(collection3)->Value(header), header, uPtr(collection3)->FontSize(40.0f), 40.0f, uPtr(collection3)->TextAlignment(1), 1, uPtr(collection3)->TextWrapping(1), 1, collection3)), ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array2), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), (collection4 = ::g::Fuse::Controls::Text::New3(), ind7 = ::g::Uno::Float4__New2(0.0f, 0.0f, 0.0f, 20.0f), uPtr(collection4)->Margin(ind7), ind7, uPtr(collection4)->Value(message), message, uPtr(collection4)->TextWrapping(1), 1, collection4)), collection1));
}
// }
...
// internal sealed class ModalDialog :1334
// {
static void ModalDialog_build(uType* type)
{
    ...
    ::TYPES[10] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof());
    ::TYPES[82] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Fuse::Controls::Control_typeof());
    ::TYPES[83] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Controls::Control_typeof());
    ::TYPES[1] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[84] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Controls::Control_typeof());
}
...
// public generated ModalDialog() :1334
void ModalDialog__ctor__fn(ModalDialog* __this)
{
    __this->ctor_();
}

// public generated ModalDialog New() :1334
void ModalDialog__New1_fn(ModalDialog** __retval)
{
    *__retval = ModalDialog::New1();
}

// public static void Show(Outracks.Simulator.FakeApp app, string header, string body, string details, Uno.Collections.IEnumerable<Fuse.Controls.Control> buttons) :1380
...
// public static void ShowPrompt(Outracks.Simulator.FakeApp app, string header, string body, Fuse.Controls.Control inputControl, Uno.Collections.IEnumerable<Fuse.Controls.Control> buttons) :1336
...
// public generated ModalDialog() [instance] :1334
void ModalDialog::ctor_()
{
}

// public generated ModalDialog New() [static] :1334
...
// public static void Show(Outracks.Simulator.FakeApp app, string header, string body, string details, Uno.Collections.IEnumerable<Fuse.Controls.Control> buttons) [static] :1380
void ModalDialog::Show(::g::Outracks::Simulator::FakeApp* app, uString* header, uString* body, uString* details, uObject* buttons)
{
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array9), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), (collection10 = ::g::Fuse::Controls::Grid::New4(), uPtr(collection10)->Rows(::STRINGS[56/*"1*,auto"*/]), ::STRINGS[56/*"1*,auto"*/], array11 = uPtr(collection10)->Children(), ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array11), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), (collection12 = ::g::Fuse::Controls::Grid::New4(), uPtr(collection12)->Rows(::STRINGS[57/*"1*,1*,2*"*/]), ::STRINGS[57/*"1*,1*,2*"*/], ind34 = ::g::Uno::Float4__New1(40.0f), uPtr(collection12)->Margin(ind34), ind34, array13 = uPtr(collection12)->Children(), ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array13), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), (collection14 = ::g::Fuse::Controls::Image::New3(), ind35 = ::g::Uno::UX::BundleFileSource::New1(::g::OutracksSimulatorClientUno_bundle::fightfc762f98()), uPtr(collection14)->File(ind35), ind35, collection14)), ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array13), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), (collection15 = ::g::Fuse::Controls::Text::New3(), uPtr(collection15)->Value(header), header, uPtr(collection15)->FontSize(25.0f), 25.0f, uPtr(collection15)->TextAlignment(1), 1, uPtr(collection15)->Alignment(8), 8, uPtr(collection15)->TextWrapping(1), 1, collection15)), ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array13), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), (collection16 = ::g::Fuse::Controls::Panel::New3(), array17 = uPtr(collection16)->Children(), ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array17), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), (collection18 = ::g::Fuse::Controls::ScrollView::New4(), ind36 = ::g::Uno::Float4__New2(0.0f, 10.0f, 0.0f, 10.0f), uPtr(collection18)->Margin(ind36), ind36, ind37 = (collection19 = ::g::Fuse::Controls::StackPanel::New4(), array20 = uPtr(collection19)->Children(), ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array20), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), (collection21 = ::g::Fuse::Controls::Text::New3(), uPtr(collection21)->TextWrapping(1), 1, uPtr(collection21)->TextAlignment(0), 0, uPtr(collection21)->Alignment(2), 2, uPtr(collection21)->Value(body), body, uPtr(collection21)->FontSize(15.0f), 15.0f, ind38 = ::g::Uno::Float4__New2(0.0f, 0.0f, 0.0f, 20.0f), uPtr(collection21)->Margin(ind38), ind38, collection21)), ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array20), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), detailPanel), collection19), uPtr(collection18)->Content(ind37), ind37, collection18)), collection16)), collection12)), ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array11), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), (collection22 = ::g::Fuse::Controls::Panel::New3(), array23 = uPtr(collection22)->Children(), ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array23), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), buttonGrid), collection22)), collection10));
    ...
    if (!::g::Uno::String::IsNullOrWhiteSpace(details))
    {
        ...
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(detailPanel)->Children()), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), detailsScroller);
    }
    ...
    for (int index27 = 0, length28 = buttonArray->Length(); index27 < length28; ++index27)
    {
        ...
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(buttonGrid)->Children()), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), btn);
    }

    uPtr(::g::Outracks::Simulator::UserAppState::Default())->ApplyTo(::g::Outracks::Simulator::Context::App());
    ::g::Uno::Collections::ICollection::Clear(uInterface(uPtr(uPtr(app)->Children1()), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(app->Children1()), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), clientPanel);
}

// public static void ShowPrompt(Outracks.Simulator.FakeApp app, string header, string body, Fuse.Controls.Control inputControl, Uno.Collections.IEnumerable<Fuse.Controls.Control> buttons) [static] :1336
void ModalDialog::ShowPrompt(::g::Outracks::Simulator::FakeApp* app, uString* header, uString* body, ::g::Fuse::Controls::Control* inputControl, uObject* buttons)
{
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array2), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), (collection3 = ::g::Fuse::Controls::Text::New3(), ind30 = ::g::Uno::Float4__New2(0.0f, 0.0f, 0.0f, 20.0f), uPtr(collection3)->Margin(ind30), ind30, uPtr(collection3)->Value(header), header, uPtr(collection3)->FontSize(40.0f), 40.0f, uPtr(collection3)->TextAlignment(1), 1, uPtr(collection3)->TextWrapping(1), 1, collection3));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array2), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), (collection4 = ::g::Fuse::Controls::Text::New3(), ind31 = ::g::Uno::Float4__New2(0.0f, 0.0f, 0.0f, 20.0f), uPtr(collection4)->Margin(ind31), ind31, uPtr(collection4)->Value(body), body, uPtr(collection4)->TextWrapping(1), 1, collection4));
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(array2), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), inputControl);
    ...
    for (uObject* enum6 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(buttons), ::TYPES[83/*Uno.Collections.IEnumerable<Fuse.Controls.Control>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum6), ::TYPES[1/*Uno.Collections.IEnumerator*/])); )
    {
        ...
        ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(buttonPanel)->Children()), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), btn);
    }

    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(stackPanel)->Children()), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), buttonPanel);
    ::g::Fuse::Controls::ClientPanel* root = ::g::Fuse::Controls::ClientPanel::New5();
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(root->Children()), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), stackPanel);
    uPtr(::g::Outracks::Simulator::UserAppState::Default())->ApplyTo(::g::Outracks::Simulator::Context::App());
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(uPtr(app)->Children1()), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Node>*/]), root);
}
// }
...
// public sealed class OfflineSimulatorClient :929
// {
static void OfflineSimulatorClient_build(uType* type)
{
    ::TYPES[85] = ::g::Outracks::Simulator::ConcurrentQueue_typeof()->MakeType(::g::Outracks::Simulator::Protocol::MessageFromClient_typeof());
    ::TYPES[86] = ::g::Outracks::Simulator::ConcurrentQueue_typeof()->MakeType(::g::Outracks::Simulator::Protocol::MessageToClient_typeof());
    type->SetInterfaces(
...
// public OfflineSimulatorClient(Outracks.Simulator.Protocol.MessageToClient[] initialMessages) :934
void OfflineSimulatorClient__ctor__fn(OfflineSimulatorClient* __this, uArray* initialMessages)
{
    __this->ctor_(initialMessages);
}

// public void Dispose() :950
void OfflineSimulatorClient__Dispose_fn(OfflineSimulatorClient* __this)
{
    __this->Dispose();
}

// public Outracks.Simulator.ConcurrentQueue<Outracks.Simulator.Protocol.MessageToClient> get_IncommingMessages() :942
...
// public bool get_IsOnline() :957
void OfflineSimulatorClient__get_IsOnline_fn(OfflineSimulatorClient* __this, bool* __retval)
{
    *__retval = __this->IsOnline();
}

// public OfflineSimulatorClient New(Outracks.Simulator.Protocol.MessageToClient[] initialMessages) :934
...
// public void Send(Outracks.Simulator.Protocol.MessageFromClient message) :945
...
// public OfflineSimulatorClient(Outracks.Simulator.Protocol.MessageToClient[] initialMessages) [instance] :934
...
// public void Dispose() [instance] :950
void OfflineSimulatorClient::Dispose()
{
}

// public Outracks.Simulator.ConcurrentQueue<Outracks.Simulator.Protocol.MessageToClient> get_IncommingMessages() [instance] :942
...
// public bool get_IsOnline() [instance] :957
...
// public void Send(Outracks.Simulator.Protocol.MessageFromClient message) [instance] :945
...
// public OfflineSimulatorClient New(Outracks.Simulator.Protocol.MessageToClient[] initialMessages) [static] :934
...
{
    ::TYPES[87] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Outracks::Simulator::Task_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof()->Array()));
    ::TYPES[45] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof());
    ::TYPES[1] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[46] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof());
    ::TYPES[88] = ::g::Outracks::Simulator::Tasks_typeof()->MakeMethod(1, ::g::Uno::Net::IPEndPoint_typeof()->Array());
    ::TYPES[89] = ::g::Uno::Func_typeof()->MakeType(::g::Uno::Net::IPEndPoint_typeof()->Array());
    ::TYPES[90] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Uno::String_typeof());
    ::TYPES[91] = ::g::Outracks::Simulator::Tasks_typeof()->MakeMethod(1, ::g::Uno::Net::IPEndPoint_typeof()->Array());
    ::TYPES[92] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::Exception_typeof()), ::g::Uno::Net::IPEndPoint_typeof()->Array());
    type->Reflection.SetFunctions(2,
...
::g::Outracks::Simulator::Task* ProxyClient::GetSimulatorEndpoint(uObject* proxyEndpoints, uString* project, uObject* defines)
{
    ...
    {
        ::g::Uno::Net::IPEndPoint* endpoint = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[46/*Uno.Collections.IEnumerator<Uno.Net.IPEndPoint>*/]), &ret3), ret3);
...
// internal sealed class Reifying :572
// {
...
// public Reifying(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.Protocol.Reify reify) :576
...
// public Reifying New(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.Protocol.Reify reify) :576
...
// public override sealed Outracks.Simulator.State OnEnterState() :582
void Reifying__OnEnterState_fn(Reifying* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    uPtr(::g::Outracks::Simulator::UserAppState::Default())->ApplyTo(::g::Outracks::Simulator::Context::App());
    ::g::Outracks::Simulator::Runtime::VirtualMachine::Execute(uPtr(__this->_reify)->AppMutator, uArray::Init<uObject*>(::TYPES[34/*object[]*/], 1, (::g::Outracks::Simulator::FakeApp*)::g::Outracks::Simulator::Context::App()));
...
// protected override sealed Outracks.Simulator.State OnFaulted(Uno.Exception e) :594
...
// public Reifying(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.Protocol.Reify reify) [instance] :576
...
// public Reifying New(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.Protocol.Reify reify) [static] :576
...
// internal sealed class Running :600
// {
static void Running_build(uType* type)
{
    ...
    ::TYPES[35] = ::g::Outracks::Simulator::ISimulatorClient_typeof();
    ::TYPES[43] = ::g::Outracks::Simulator::DialogButton_typeof()->Array();
    ::TYPES[93] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Visual_typeof());
    ::TYPES[94] = ::g::Uno::Collections::IList_typeof()->MakeType(::g::Fuse::Visual_typeof());
    type->SetFields(1,
...
// public Running(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.UserAppState userApp, Outracks.Simulator.Protocol.Reify runningReify) :607
...
// private static string GetTag(Fuse.Node node) :674
void Running__GetTag_fn(::g::Fuse::Node* node, uString** __retval)
{
    *__retval = Running::GetTag(node);
}

// public Running New(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.UserAppState userApp, Outracks.Simulator.Protocol.Reify runningReify) :607
...
// public override sealed Outracks.Simulator.State OnEnterState() :617
...
// protected override sealed Outracks.Simulator.State OnFaulted(Uno.Exception e) :641
...
// public override sealed void OnLeaveState() :624
...
// public override sealed Outracks.Simulator.State OnPointerPressed(Fuse.Input.PointerPressedArgs args) :652
void Running__OnPointerPressed_fn(Running* __this, ::g::Fuse::Input::PointerPressedArgs* args, ::g::Outracks::Simulator::State** __retval)
{
    ...
    uString* selectedTag = (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(nodes), ::TYPES[93/*Uno.Collections.ICollection<Fuse.Visual>*/])) >= 1) ? (uString*)Running::GetTag((::g::Uno::Collections::IList::get_Item_ex(uInterface(uPtr(nodes), ::TYPES[94/*Uno.Collections.IList<Fuse.Visual>*/]), uCRef<int>(0), &ret2), ret2)) : ::STRINGS[27/*"N/A"*/];
    ::g::Outracks::Simulator::ISimulatorClient::Send(uInterface(uPtr(__this->Client), ::TYPES[35/*Outracks.Simulator.ISimulatorClient*/]), ::g::Outracks::Simulator::Protocol::SetSelection::New1(selectedTag));
    ::g::Fuse::Preview::SelectionManager::SetSelection((uObject*)::g::Outracks::Simulator::Runtime::Selection::New1(selectedTag, NULL));
    args->IsHandled(true);
    return *__retval = __this, void();
}

// public override sealed Outracks.Simulator.State OnUpdate() :629
void Running__OnUpdate_fn(Running* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    {
        ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[59/*"Density cha...*/], 1, ::STRINGS[9/*"C:\\Program...*/], 634);
...
// private static float QueryDensity() :646
void Running__QueryDensity_fn(float* __retval)
{
    *__retval = Running::QueryDensity();
}

// public Running(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.UserAppState userApp, Outracks.Simulator.Protocol.Reify runningReify) [instance] :607
...
// private static string GetTag(Fuse.Node node) [static] :674
...
// public Running New(Outracks.Simulator.ISimulatorClient client, Outracks.Simulator.UserAppState userApp, Outracks.Simulator.Protocol.Reify runningReify) [static] :607
...
// private static float QueryDensity() [static] :646
...
{
    ::TYPES[95] = ::g::Uno::Func1_typeof()->MakeType(::g::Uno::IO::BinaryReader_typeof(), ::g::Uno::String_typeof());
    type->SetFields(0,
...
// internal class ShowingModalDialog :1555
// {
static void ShowingModalDialog_build(uType* type)
{
    ::STRINGS[9] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Outracks.Simulator.Client.Uno\\0.1.0\\$.uno");
    ::TYPES[96] = ::g::Outracks::Simulator::Bytecode::Optional_typeof()->MakeMethod(1, ::g::Outracks::Simulator::DialogButton_typeof());
    ::TYPES[97] = ::g::Uno::Collections::List_typeof()->MakeType(::g::Fuse::Controls::Control_typeof());
    ::TYPES[98] = ::g::Outracks::Simulator::Closure_typeof()->MakeMethod(1, ::g::Outracks::Simulator::DialogButton_typeof());
    ::TYPES[99] = ::g::Uno::Action1_typeof()->MakeType(::g::Outracks::Simulator::DialogButton_typeof());
    ::TYPES[52] = ::g::Fuse::Gestures::ClickedHandler_typeof();
    ::TYPES[100] = ::g::Outracks::Simulator::ForgetAction_typeof()->MakeType(uObject_typeof(), ::g::Fuse::Gestures::ClickedArgs_typeof());
    ::TYPES[101] = ::g::Outracks::Simulator::Bytecode::Optional1_typeof()->MakeType(::g::Outracks::Simulator::DialogButton_typeof());
    type->SetFields(0,
...
// public ShowingModalDialog(string header, string body, string details, Outracks.Simulator.DialogButton[] buttons) :1564
...
// public ShowingModalDialog New(string header, string body, string details, Outracks.Simulator.DialogButton[] buttons) :1564
...
// private void OnButtonClicked(Outracks.Simulator.DialogButton button) :1597
...
// public override sealed Outracks.Simulator.State OnEnterState() :1576
void ShowingModalDialog__OnEnterState_fn(ShowingModalDialog* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    for (array1 = __this->_buttons, index2 = 0, length3 = uPtr(array1)->Length(); index2 < length3; ++index2)
    {
        ...
        uDelegate* handler = uDelegate::New(::TYPES[52/*Fuse.Gestures.ClickedHandler*/], (void*)::g::Outracks::Simulator::ForgetAction__Execute_fn, (::g::Outracks::Simulator::ForgetAction*)::g::Outracks::Simulator::ForgetAction::New1(::TYPES[100/*Outracks.Simulator.ForgetAction<object, Fuse.Gestures.ClickedArgs>*/], action));
...
// public override sealed Outracks.Simulator.State OnException(Uno.Exception e) :1610
void ShowingModalDialog__OnException_fn(ShowingModalDialog* __this, ::g::Uno::Exception* e, ::g::Outracks::Simulator::State** __retval)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(uPtr(e)->Message(), 1, ::STRINGS[9/*"C:\\Program...*/], 1612);
    return *__retval = __this, void();
}

// public override sealed Outracks.Simulator.State OnUpdate() :1602
...
// public ShowingModalDialog(string header, string body, string details, Outracks.Simulator.DialogButton[] buttons) [instance] :1564
...
// private void OnButtonClicked(Outracks.Simulator.DialogButton button) [instance] :1597
...
// public ShowingModalDialog New(string header, string body, string details, Outracks.Simulator.DialogButton[] buttons) [static] :1564
...
// internal abstract class ShowingPrompt :1484
// {
static void ShowingPrompt_build(uType* type)
{
    ...
    ::STRINGS[9] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Outracks.Simulator.Client.Uno\\0.1.0\\$.uno");
    ::TYPES[52] = ::g::Fuse::Gestures::ClickedHandler_typeof();
    ::TYPES[102] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof()->MakeType(::g::Fuse::Controls::Control_typeof());
...
// protected ShowingPrompt(string header, string body) :1493
void ShowingPrompt__ctor_1_fn(ShowingPrompt* __this, uString* header, uString* body)
{
    __this->ctor_1(header, body);
}

// private void OnCancelClicked(object s, Fuse.Gestures.ClickedArgs args) :1534
...
// public override sealed Outracks.Simulator.State OnEnterState() :1501
void ShowingPrompt__OnEnterState_fn(ShowingPrompt* __this, ::g::Outracks::Simulator::State** __retval)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::STRINGS[62/*"# "*/], __this->_header), 1, ::STRINGS[9/*"C:\\Program...*/], 1522);
    ::g::Uno::Diagnostics::Debug::Log5(__this->_body, 1, ::STRINGS[9/*"C:\\Program...*/], 1523);
...
// private void OnOkClicked(object s, Fuse.Gestures.ClickedArgs args) :1529
...
// public override sealed Outracks.Simulator.State OnUpdate() :1543
...
// protected ShowingPrompt(string header, string body) [instance] :1493
...
// private void OnCancelClicked(object s, Fuse.Gestures.ClickedArgs args) [instance] :1534
...
// private void OnOkClicked(object s, Fuse.Gestures.ClickedArgs args) [instance] :1529
...
// public sealed class SimulatorClient :1018
// {
...
void SimulatorClient::ctor_(::g::Uno::Net::Sockets::Socket* socket)
{
    ...
    _readWorker = ::g::Uno::Threading::Thread::Create(uDelegate::New(::TYPES[7/*Uno.Action*/], (void*)SimulatorClient__ReadLoop_fn, this));
    _writeWorker = ::g::Uno::Threading::Thread::Create(uDelegate::New(::TYPES[7/*Uno.Action*/], (void*)SimulatorClient__WriteLoop_fn, this));
    uPtr(_readWorker)->Start();
    uPtr(_writeWorker)->Start();
}

// public void Dispose() [instance] :1103
void SimulatorClient::Dispose()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Uno::Diagnostics::Debug::Log5(uPtr(e)->Message(), 1, ::STRINGS[9/*"C:\\Program...*/], 1118);
    }
}

// public Outracks.Simulator.ConcurrentQueue<Outracks.Simulator.Protocol.MessageToClient> get_IncommingMessages() [instance] :1031
...
// public bool get_IsOnline() [instance] :1124
...
// private void ReadLoop() [instance] :1065
...
// public void Send(Outracks.Simulator.Protocol.MessageFromClient message) [instance] :1034
...
// private void WriteLoop() [instance] :1083
...
// public SimulatorClient New(Uno.Net.Sockets.Socket socket) [static] :1039
...
// internal abstract class State :294
// {
...
// protected generated State() :294
void State__ctor__fn(State* __this)
{
    __this->ctor_();
}

// public virtual Outracks.Simulator.State OnEnterState() :296
...
// public virtual void OnLeaveState() :301
void State__OnLeaveState_fn(State* __this)
{
}

// public virtual Outracks.Simulator.State OnPointerPressed(Fuse.Input.PointerPressedArgs args) :310
...
// public virtual Outracks.Simulator.State OnUpdate() :305
...
// protected generated State() [instance] :294
void State::ctor_()
{
}
// }
...
{
    ::TYPES[104] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[1] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[105] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Uno::String_typeof());
    ::TYPES[74] = ::g::Uno::Collections::IEnumerable_typeof();
    ::TYPES[81] = ::g::Uno::Collections::IEnumerator1_typeof();
    type->SetPrecalc(
...
uString* StringSplitting::Join(uObject* si, uString* separator)
{
    ...
    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(si), ::TYPES[104/*Uno.Collections.IEnumerable<string>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[1/*Uno.Collections.IEnumerator*/])); )
    {
        uString* part = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[105/*Uno.Collections.IEnumerator<string>*/]), &ret2), ret2);
...
{
    ::TYPES[106] = ::g::Outracks::Simulator::TaskThread_typeof();
    ::TYPES[107] = ::g::Uno::Func_typeof();
    ::TYPES[108] = ::g::Outracks::Simulator::WaitForFirstResult_typeof();
    type->SetPrecalc(
...
{
    ::TYPES[7] = ::g::Uno::Action_typeof();
    ::TYPES[109] = ::g::Outracks::Simulator::Task_typeof();
    ::TYPES[11] = ::g::Uno::Exception_typeof();
    type->SetPrecalc(
...
void TaskThread::ctor_(uDelegate* func)
{
    ...
    _func = func;
    Thread = ::g::Uno::Threading::Thread::Create(uDelegate::New(::TYPES[7/*Uno.Action*/], (void*)TaskThread__Run_fn, this));
    Task = ((::g::Outracks::Simulator::Task*)::g::Outracks::Simulator::Task::New1(__types[0], uDelegate::New(::TYPES[7/*Uno.Action*/], uPtr(Thread), offsetof(::g::Uno::Threading::Thread_type, fp_Join))));
}
...
// internal sealed class Uninitialized :342
// {
...
// public generated Uninitialized() :342
void Uninitialized__ctor_1_fn(Uninitialized* __this)
{
    __this->ctor_1();
}

// public generated Uninitialized New() :342
void Uninitialized__New1_fn(Uninitialized** __retval)
{
    *__retval = Uninitialized::New1();
}

// public override sealed Outracks.Simulator.State OnException(Uno.Exception e) :352
void Uninitialized__OnException_fn(Uninitialized* __this, ::g::Uno::Exception* e, ::g::Outracks::Simulator::State** __retval)
{
    ...
    return *__retval = ::g::Outracks::Simulator::Faulted::New2(false, e, uArray::Init< ::g::Outracks::Simulator::DialogButton*>(::TYPES[43/*Outracks.Simulator.DialogButton[]*/], 1, (::g::Outracks::Simulator::DialogButton*)::g::Outracks::Simulator::DialogButton::New1(::STRINGS[44/*"Try again"*/], __this))), void();
}

// public override sealed Outracks.Simulator.State OnUpdate() :344
...
// public generated Uninitialized() [instance] :342
...
// public generated Uninitialized New() [static] :342
...
// internal sealed class UserAppState :828
// {
static void UserAppState_build(uType* type)
{
    ::TYPES[110] = UserAppState_typeof()->MakeMethod(1, ::g::Fuse::Node_typeof());
    ::TYPES[111] = UserAppState_typeof()->MakeMethod(1, ::g::Uno::UX::Resource_typeof());
    ::TYPES[112] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Fuse::Node_typeof());
    ::TYPES[113] = ::g::Uno::Collections::EnumerableExtensions_typeof()->MakeMethod(1, ::g::Uno::UX::Resource_typeof());
    ::TYPES[114] = ::g::Uno::Collections::ICollection_typeof();
    ::TYPES[115] = ::g::Uno::Collections::IList_typeof();
    ::TYPES[116] = ::g::Uno::Collections::IListExtensions_typeof();
    ::TYPES[75] = ::g::Uno::Runtime::Implementation::Internal::ArrayEnumerable_typeof();
    type->SetPrecalc(
...
// public UserAppState(float4 background, Fuse.Node[] children, Uno.UX.Resource[] resources, float4 clearColor, float clearDepth) :842
...
// public void ApplyTo(Outracks.Simulator.FakeApp app) :869
void UserAppState__ApplyTo_fn(UserAppState* __this, ::g::Outracks::Simulator::FakeApp* app)
{
    __this->ApplyTo(app);
}

// public static generated Outracks.Simulator.UserAppState get_Default() :857
void UserAppState__get_Default_fn(UserAppState** __retval)
{
    *__retval = UserAppState::Default();
}

// public static generated void set_Default(Outracks.Simulator.UserAppState value) :857
void UserAppState__set_Default_fn(UserAppState* value)
{
    UserAppState::Default(value);
}

// public UserAppState New(float4 background, Fuse.Node[] children, Uno.UX.Resource[] resources, float4 clearColor, float clearDepth) :842
...
// public static Outracks.Simulator.UserAppState Save(Outracks.Simulator.FakeApp app) :859
void UserAppState__Save_fn(::g::Outracks::Simulator::FakeApp* app, UserAppState** __retval)
{
    *__retval = UserAppState::Save(app);
}

// private static bool SequenceEquals<T>(Uno.Collections.IList<T> left, T[] right) :890
...
// private static void SetIfNotEqual<T>(Uno.Collections.IList<T> list, T[] elements) :878
...
// private static void SetSequence<T>(Uno.Collections.IList<T> list, T[] elements) :884
...
// public UserAppState(float4 background, Fuse.Node[] children, Uno.UX.Resource[] resources, float4 clearColor, float clearDepth) [instance] :842
...
// public void ApplyTo(Outracks.Simulator.FakeApp app) [instance] :869
void UserAppState::ApplyTo(::g::Outracks::Simulator::FakeApp* app)
{
    ...
    UserAppState::SetIfNotEqual(::TYPES[110/*Outracks.Simulator.UserAppState.SetIfNotEqual<Fuse.Node>*/], uPtr(app)->Children1(), Children);
    UserAppState::SetIfNotEqual(::TYPES[111/*Outracks.Simulator.UserAppState.SetIfNotEqual<Uno.UX.Resource>*/], app->Resources1(), Resources);
...
// public UserAppState New(float4 background, Fuse.Node[] children, Uno.UX.Resource[] resources, float4 clearColor, float clearDepth) [static] :842
...
// public static Outracks.Simulator.UserAppState Save(Outracks.Simulator.FakeApp app) [static] :859
UserAppState* UserAppState::Save(::g::Outracks::Simulator::FakeApp* app)
{
    ...
    return UserAppState::New1(uPtr(app)->Background1(), (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[112/*Uno.Collections.EnumerableExtensions.ToArray<Fuse.Node>*/], uPtr(app)->Children1()), (uArray*)::g::Uno::Collections::EnumerableExtensions::ToArray(::TYPES[113/*Uno.Collections.EnumerableExtensions.ToArray<Uno.UX.Resource>*/], uPtr(app)->Resources1()), uPtr(app)->ClearColor(), uPtr(app)->ClearDepth());
}

// private static bool SequenceEquals<T>(Uno.Collections.IList<T> left, T[] right) [static] :890
...
// private static void SetIfNotEqual<T>(Uno.Collections.IList<T> list, T[] elements) [static] :878
...
// private static void SetSequence<T>(Uno.Collections.IList<T> list, T[] elements) [static] :884
...
// public static generated Outracks.Simulator.UserAppState get_Default() [static] :857
...
// public static generated void set_Default(Outracks.Simulator.UserAppState value) [static] :857
