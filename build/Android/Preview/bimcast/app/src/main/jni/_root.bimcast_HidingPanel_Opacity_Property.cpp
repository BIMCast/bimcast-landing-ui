...
{
    uStackFrame __("bimcast_HidingPanel_Opacity_Property", "Get()");
...
{
    uStackFrame __("bimcast_HidingPanel_Opacity_Property", "get_Object()");
...
{
    uStackFrame __("bimcast_HidingPanel_Opacity_Property", "Set(float,Uno.UX.IPropertyListener)");
    float v_ = *v;
...
{
    uStackFrame __("bimcast_HidingPanel_Opacity_Property", "get_SupportsOriginSetter()");
...
{
    uStackFrame __("bimcast_HidingPanel_Opacity_Property", ".ctor(HidingPanel,Uno.UX.Selector)");
    ctor_1(name);
    _obj = obj;
}
