// This file was generated based on C:\Users\ManailMJ\Documents\Dev\fuse\projects\bimcast\build\Android\Preview\cache\ux11\HidingPanel.g.uno.
...
static void HidingPanel_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)HidingPanel__New4_fn, 0, true, HidingPanel_typeof(), 0));
}
...
{
    uStackFrame __("HidingPanel", ".ctor()");
    ctor_6();
    InitializeUX();
}
...
{
    uStackFrame __("HidingPanel", "InitializeUX()");
    this_Opacity_inst = ::g::bimcast_HidingPanel_Opacity_Property::New1(this, HidingPanel::__selector0());
