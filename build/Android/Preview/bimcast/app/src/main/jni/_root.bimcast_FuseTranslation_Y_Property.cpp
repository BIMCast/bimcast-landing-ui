...
{
    uStackFrame __("bimcast_FuseTranslation_Y_Property", "Get()");
...
{
    uStackFrame __("bimcast_FuseTranslation_Y_Property", "get_Object()");
...
{
    uStackFrame __("bimcast_FuseTranslation_Y_Property", "Set(float,Uno.UX.IPropertyListener)");
    float v_ = *v;
...
{
    uStackFrame __("bimcast_FuseTranslation_Y_Property", "get_SupportsOriginSetter()");
...
{
    uStackFrame __("bimcast_FuseTranslation_Y_Property", ".ctor(Fuse.Translation,Uno.UX.Selector)");
    ctor_1(name);
    _obj = obj;
}
