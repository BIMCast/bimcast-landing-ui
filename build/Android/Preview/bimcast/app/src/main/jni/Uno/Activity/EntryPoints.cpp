...
jint JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    jclass activityClass = env->FindClass("com/apps/bimcast/bimcast");
    jclass entryPointsClass = env->FindClass("com/apps/bimcast/ActivityNativeEntryPoints");
    jclass displayClass = env->FindClass("com/apps/bimcast/Display");
