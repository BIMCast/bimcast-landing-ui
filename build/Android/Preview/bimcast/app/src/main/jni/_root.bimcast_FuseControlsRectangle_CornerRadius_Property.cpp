...
{
    uStackFrame __("bimcast_FuseControlsRectangle_CornerRadius_Property", "Get()");
...
{
    uStackFrame __("bimcast_FuseControlsRectangle_CornerRadius_Property", "get_Object()");
...
{
    uStackFrame __("bimcast_FuseControlsRectangle_CornerRadius_Property", "Set(float4,Uno.UX.IPropertyListener)");
    ::g::Uno::Float4 v_ = *v;
...
{
    uStackFrame __("bimcast_FuseControlsRectangle_CornerRadius_Property", "get_SupportsOriginSetter()");
...
{
    uStackFrame __("bimcast_FuseControlsRectangle_CornerRadius_Property", ".ctor(Fuse.Controls.Rectangle,Uno.UX.Selector)");
    ctor_1(name);
    _obj = obj;
}
