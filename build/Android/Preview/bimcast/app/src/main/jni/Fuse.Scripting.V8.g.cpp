...
static void Debugger__Connected_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Scripting.V8\\0.35.12\\$.uno");
...
void Debugger__Connected::ctor_(::g::Fuse::Scripting::V8::Debugger* parent, ::g::Uno::Net::Sockets::Socket* socket, ::g::Uno::IO::TextReader* reader)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[0/*"DEBUG_V8: C...*/], 1, ::STRINGS[1/*"C:\\Program...*/], 571);
    _parent = parent;
    _socket = socket;
    _reader = reader;
}
...
void Context::ctor_1(uObject* worker)
{
    ...
    _errorFactory = uAs< ::g::Fuse::Scripting::V8::Function*>(Evaluate(::STRINGS[3/*"(no file)"*/], ::STRINGS[4/*"(function(m...*/]), ::TYPES[8/*Fuse.Scripting.V8.Function*/]);
}
...
static void Debugger_build(uType* type)
{
    ...
    ::STRINGS[22] = uString::Const("0.35.12");
...
uObject* Debugger::Connect(Debugger* parent)
{
    ...
    ::g::Uno::Diagnostics::Debug::Log5(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[16/*"DEBUG_V8: W...*/], uBox<int>(::TYPES[17/*int*/], parent->_port)), ::STRINGS[17/*"..."*/]), 1, ::STRINGS[1/*"C:\\Program...*/], 419);
