...
{
    uStackFrame __("bimcast_HidingPanel_IsEnabled_Property", "Get()");
...
{
    uStackFrame __("bimcast_HidingPanel_IsEnabled_Property", "get_Object()");
...
{
    uStackFrame __("bimcast_HidingPanel_IsEnabled_Property", "Set(bool,Uno.UX.IPropertyListener)");
    bool v_ = *v;
...
{
    uStackFrame __("bimcast_HidingPanel_IsEnabled_Property", "get_SupportsOriginSetter()");
...
{
    uStackFrame __("bimcast_HidingPanel_IsEnabled_Property", ".ctor(HidingPanel,Uno.UX.Selector)");
    ctor_1(name);
    _obj = obj;
}
