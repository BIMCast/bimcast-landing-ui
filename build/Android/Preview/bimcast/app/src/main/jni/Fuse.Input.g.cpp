...
// C:\ProgramData\Uno\Packages\FuseCore\0.35.12\Input\$.uno
// --------------------------------------------------------
...
static void Pointer_build(uType* type)
{
    ...
    ::STRINGS[10] = uString::Const("C:\\ProgramData\\Uno\\Packages\\FuseCore\\0.35.12\\Input\\$.uno");
...
::g::Fuse::Input::PointerWheelMovedArgs* Pointer::RaiseWheelMoved(::g::Fuse::Visual* root, ::g::Fuse::Input::PointerEventData* data)
{
    ...
    ::g::Fuse::Input::IPointerEventResponder::OnPointerWheelMoved(uInterface(uPtr(Pointer::EventResponder()), ::TYPES[28/*Fuse.Input.IPointerEventResponder*/]), e);
    return e;
}
...
void PointerEventArgs__Serialize_fn(PointerEventArgs* __this, uObject* s)
{
    ...
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(uPtr(s), ::TYPES[37/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[15/*"x"*/], (double)__this->WindowPoint().X);
    ::g::Fuse::Scripting::IEventSerializer::AddDouble(uInterface(s, ::TYPES[37/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[16/*"y"*/], (double)__this->WindowPoint().Y);
    ::g::Fuse::Scripting::IEventSerializer::AddInt(uInterface(s, ::TYPES[37/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[17/*"index"*/], __this->PointIndex());
}
...
void TextEnteredArgs__Serialize_fn(TextEnteredArgs* __this, uObject* s)
{
    ...
    ::g::Fuse::Scripting::IEventSerializer::AddString(uInterface(uPtr(s), ::TYPES[37/*Fuse.Scripting.IEventSerializer*/]), ::STRINGS[18/*"text"*/], __this->Text());
}
