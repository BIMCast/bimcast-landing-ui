...
int AndroidProperties::GetBuildVersion()
{
    uStackFrame __("Fuse.AndroidProperties", "GetBuildVersion()");
    {
        ...
        WITH_STATIC_JAVA_METHOD(__mtd, __cls, "GetBuildVersion247", "()I");
...
// C:\ProgramData\Uno\Packages\Fuse.Entities\0.35.12\Processing\$.uno
// ------------------------------------------------------------------
...
static void UserEvent_build(uType* type)
{
    ...
    ::STRINGS[53] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.UserEvents\\0.35.12\\$.uno");
...
void UserEvent__OnRooted_fn(UserEvent* __this)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[52/*"UserEvent r...*/], __this, ::STRINGS[53/*"C:\\Program...*/], 638, ::STRINGS[54/*"OnRooted"*/]);
        return;
    }
...
void UserEvent::Raise(::g::Uno::Collections::Dictionary* args)
{
    ...
    if (Dispatch == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[57/*"Trying to R...*/], this, ::STRINGS[53/*"C:\\Program...*/], 685, ::STRINGS[58/*"Raise"*/]);
        return;
    }
...
void UserEvent::raise(::g::Fuse::Scripting::Context* c, UserEvent* n, uArray* args)
{
    ...
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[55/*"Raise must ...*/], n, ::STRINGS[53/*"C:\\Program...*/], 421, ::STRINGS[51/*"raise"*/]);
        return;
    }
    ...
    if (so == NULL)
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[56/*"Raise must ...*/], uPtr(args)->Strong<uObject*>(0), ::STRINGS[53/*"C:\\Program...*/], 428, ::STRINGS[51/*"raise"*/]);
        return;
    }
...
void UserEvent::RaiseEvent(::g::Fuse::Visual* from, ::g::Uno::UX::Selector name, ::g::Uno::Collections::Dictionary* args)
{
    ...
    if (ev == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::g::Uno::String::op_Addition2(::STRINGS[59/*"Unknown eve...*/], ::g::Uno::UX::Selector__op_Implicit1(name)), NULL, ::STRINGS[53/*"C:\\Program...*/], 698, ::STRINGS[60/*"RaiseEvent"*/]);
        return;
    }
...
void VisualEvent::Raise(::g::Fuse::VisualEventArgs* args, int type, bool bubble, uDelegate* PostBubbleAction)
{
    ...
    switch (type)
    {
        ...
        default:
        {
            ::g::Uno::Diagnostics::Debug::Log5(::STRINGS[69/*"Invalid Rai...*/], 1, ::STRINGS[3/*"C:\\Program...*/], 1648);
            return;
        }
    }
