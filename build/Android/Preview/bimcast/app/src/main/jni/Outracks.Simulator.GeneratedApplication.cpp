// This file was generated based on C:\Users\ManailMJ\Documents\Dev\fuse\projects\bimcast\build\Android\Preview\preamble\$.uno.
...
static void GeneratedApplication_build(uType* type)
{
    ...
    ::STRINGS[1] = uString::Const("192.168.8.102");
    ::STRINGS[2] = uString::Const("C:\\Users\\ManailMJ\\Documents\\Dev\\fuse\\projects\\bimcast\\bimcast.unoproj");
    ::STRINGS[3] = uString::Const("bimcast");
...
::g::Uno::IO::Bundle* GeneratedApplication::GetBundle()
{
    ...
    return ::g::Uno::IO::Bundle::Get(::STRINGS[3/*"bimcast"*/]);
}
