...
{
    uStackFrame __("bimcast_FuseControlsRectangle_Width_Property", "Get()");
...
{
    uStackFrame __("bimcast_FuseControlsRectangle_Width_Property", "get_Object()");
...
{
    uStackFrame __("bimcast_FuseControlsRectangle_Width_Property", "Set(Uno.UX.Size,Uno.UX.IPropertyListener)");
    ::g::Uno::UX::Size v_ = *v;
...
{
    uStackFrame __("bimcast_FuseControlsRectangle_Width_Property", "get_SupportsOriginSetter()");
...
{
    uStackFrame __("bimcast_FuseControlsRectangle_Width_Property", ".ctor(Fuse.Controls.Rectangle,Uno.UX.Selector)");
    ctor_1(name);
    _obj = obj;
}
