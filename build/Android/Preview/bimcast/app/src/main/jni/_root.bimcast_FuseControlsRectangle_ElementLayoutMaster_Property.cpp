...
// public bimcast_FuseControlsRectangle_ElementLayoutMaster_Property(Fuse.Controls.Rectangle obj, Uno.UX.Selector name) :94
...
// public override sealed Fuse.Elements.Element Get() :96
...
{
    uStackFrame __("bimcast_FuseControlsRectangle_ElementLayoutMaster_Property", "Get()");
    return *__retval = ::g::Fuse::Controls::LayoutControl::GetLayoutMaster(__this->_obj), void();
}

// public bimcast_FuseControlsRectangle_ElementLayoutMaster_Property New(Fuse.Controls.Rectangle obj, Uno.UX.Selector name) :94
...
{
    uStackFrame __("bimcast_FuseControlsRectangle_ElementLayoutMaster_Property", "get_Object()");
    return *__retval = __this->_obj, void();
}

// public override sealed void Set(Fuse.Elements.Element v, Uno.UX.IPropertyListener origin) :97
...
{
    uStackFrame __("bimcast_FuseControlsRectangle_ElementLayoutMaster_Property", "Set(Fuse.Elements.Element,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("bimcast_FuseControlsRectangle_ElementLayoutMaster_Property", "get_SupportsOriginSetter()");
    return *__retval = false, void();
}

// public bimcast_FuseControlsRectangle_ElementLayoutMaster_Property(Fuse.Controls.Rectangle obj, Uno.UX.Selector name) [instance] :94
...
{
    uStackFrame __("bimcast_FuseControlsRectangle_ElementLayoutMaster_Property", ".ctor(Fuse.Controls.Rectangle,Uno.UX.Selector)");
    ctor_1(name);
    _obj = obj;
}

// public bimcast_FuseControlsRectangle_ElementLayoutMaster_Property New(Fuse.Controls.Rectangle obj, Uno.UX.Selector name) [static] :94
