...
static void RaiseUserEvent_build(uType* type)
{
    ...
    ::STRINGS[8] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.UserEvents\\0.35.12\\$.uno");
...
void RaiseUserEvent__Perform_fn(RaiseUserEvent* __this, ::g::Fuse::Node* target)
{
    ...
    if (__this->_event == NULL)
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[7/*"no UserEven...*/], ::g::Uno::UX::Selector__op_Implicit1(__this->EventName())), __this, ::STRINGS[8/*"C:\\Program...*/], 240, ::STRINGS[9/*"Perform"*/]);
    else
...
static void ReleasePage_build(uType* type)
{
    ...
    ::STRINGS[11] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Controls.Navigation\\0.35.12\\$.uno");
    ::STRINGS[9] = uString::Const("Perform");
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
