...
{
    uStackFrame __("bimcast_FuseTriggersStateGroup_Active_Property", "Get()");
...
{
    uStackFrame __("bimcast_FuseTriggersStateGroup_Active_Property", "get_Object()");
...
{
    uStackFrame __("bimcast_FuseTriggersStateGroup_Active_Property", "Set(Fuse.Triggers.State,Uno.UX.IPropertyListener)");
...
{
    uStackFrame __("bimcast_FuseTriggersStateGroup_Active_Property", "get_SupportsOriginSetter()");
...
{
    uStackFrame __("bimcast_FuseTriggersStateGroup_Active_Property", ".ctor(Fuse.Triggers.StateGroup,Uno.UX.Selector)");
    ctor_1(name);
    _obj = obj;
}
