...
static void FuseCore_bundle_build(uType* type)
{
    ...
    type->Reflection.SetFields(2,
        ...
        new uField("RobotoRegulardb81a0e3", 1));
}
...
// C:\ProgramData\Uno\Packages\Fuse.Drawing.Polygons\0.35.12\.uno\package
// ----------------------------------------------------------------------
...
{
    FuseReactive_bundle::es6promise4bde52e5_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[152/*"Fuse.Reactive"*/]))->GetFile(::STRINGS[153/*"es6-promise...*/]);
    FuseReactive_bundle::Observable8fa3ae58_ = uPtr(::g::Uno::IO::Bundle::Get(::STRINGS[152/*"Fuse.Reactive"*/]))->GetFile(::STRINGS[154/*"observable-...*/]);
}
...
static void FuseReactive_bundle_build(uType* type)
{
    ...
    type->Reflection.SetFields(2,
        new uField("es6promise4bde52e5", 0),
        new uField("Observable8fa3ae58", 1));
}
...
// C:\ProgramData\Uno\Packages\Outracks.Simulator.Client.Uno\0.1.0\.uno\ux11\$.uno
// -------------------------------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\UnoCore\0.35.8\.uno\package
// -------------------------------------------------------
