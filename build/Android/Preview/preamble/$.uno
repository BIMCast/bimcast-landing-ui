...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("192.168.8.102"), 12124)}, "C:\\Users\\ManailMJ\\Documents\\Dev\\fuse\\projects\\bimcast\\bimcast.unoproj", GetBundle, new string[] { })
{
...
{
return Uno.IO.Bundle.Get("bimcast");
}
}
}
