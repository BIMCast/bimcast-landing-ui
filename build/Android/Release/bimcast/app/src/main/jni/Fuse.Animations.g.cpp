...
void MasterBase::Register(::g::Fuse::Animations::MixerHandle* handle)
{
    ...
    if (_inactive)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[5/*"Attempt to ...*/], this, ::STRINGS[2/*"C:\\Program...*/], 1615, ::STRINGS[6/*"Register"*/]);
        return;
    }
...
void MasterProperty::GiveOriginSetterWarning()
{
    ...
    {
        _warningGiven = true;
        ::g::Fuse::Diagnostics::UserWarning(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[7/*"The property "*/], ::g::Uno::UX::Selector__op_Implicit1(uPtr(Property)->Name())), ::STRINGS[8/*" of "*/]), uPtr(Property)->Object()), ::STRINGS[9/*" cannot be ...*/]), this, ::STRINGS[2/*"C:\\Program...*/], 1772, ::STRINGS[10/*"GiveOriginS...*/]);
    }
}
// }
...
void ResizeAnimatorState::ctor_2(::g::Fuse::Animations::Resize* r, ::g::Fuse::Animations::CreateStateParams* p)
{
    ...
    if (_target == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[12/*"Resize star...*/], r, ::STRINGS[2/*"C:\\Program...*/], 2717, ::STRINGS[13/*".ctor"*/]);
        _valid = false;
        return;
    }
    ...
    if (_relativeTo == NULL)
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[14/*"Resize star...*/], r, ::STRINGS[2/*"C:\\Program...*/], 2725, ::STRINGS[13/*".ctor"*/]);
        _valid = false;
        return;
    }
