...
// C:\ProgramData\Uno\Packages\Fuse.Elements\0.35.12\$.uno
// -------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\Fuse.Elements\0.35.12\Caching\$.uno
// ---------------------------------------------------------------
...
static void Element_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Elements\\0.35.12\\$.uno");
...
void Element__Draw_fn(Element* __this, ::g::Fuse::DrawContext* dc)
{
    if (!__this->IsRootingCompleted())
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[7/*"Draw called...*/], __this, ::STRINGS[4/*"C:\\Program...*/], 806, ::STRINGS[8/*"Draw"*/]);
...
// protected override sealed Fuse.VisualBounds get_HitTestChildrenBounds() :1168
...
// public override sealed Fuse.VisualBounds get_LocalRenderBounds() :739
...
// protected override sealed void PrependImplicitTransform(Fuse.FastMatrix m) :2176
...
void Element::Composit(::g::Fuse::DrawContext* dc)
{
    ...
    if (!flat && !_warnOpacityFlat)
    {
        ...
        ::g::Fuse::Diagnostics::UserWarning(::STRINGS[3/*"This elemen...*/], this, ::STRINGS[4/*"C:\\Program...*/], 970, ::STRINGS[5/*"Composit"*/]);
    }
    ...
    if (!r && !_warnNoCacheDraw)
    {
        ...
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[6/*"This elemen...*/], this, ::STRINGS[4/*"C:\\Program...*/], 978, ::STRINGS[5/*"Composit"*/]);
    }
}
...
{
    InteractiveTransform::_zoomFactorName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[18/*"ZoomFactor"*/]);
    InteractiveTransform::_rotationName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[19/*"Rotation"*/]);
    InteractiveTransform::_translationName_ = ::g::Uno::UX::Selector__op_Implicit(::STRINGS[20/*"Translation"*/]);
}

static void InteractiveTransform_build(uType* type)
{
    ::STRINGS[18] = uString::Const("ZoomFactor");
    ::STRINGS[19] = uString::Const("Rotation");
    ::STRINGS[20] = uString::Const("Translation");
    type->SetInterfaces(
