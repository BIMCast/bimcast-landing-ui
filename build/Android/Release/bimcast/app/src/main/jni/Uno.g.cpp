...
// C:\ProgramData\Uno\Packages\UnoCore\0.35.8\Source\Uno\$.uno
// -----------------------------------------------------------
...
// C:\ProgramData\Uno\Packages\UnoCore\0.35.8\Source\Uno\Exceptions\$.uno
// ----------------------------------------------------------------------
...
{
    ::STRINGS[41] = uString::Const("Value was either too large or too small for unsigned int");
    ::STRINGS[42] = uString::Const("Unable to convert string to unsigned int");
    ::TYPES[3] = uObject_typeof();
}
...
{
    ::STRINGS[43] = uString::Const("Value was either too large or too small for unsigned short");
    ::STRINGS[44] = uString::Const("Unable to convert string to unsigned short");
    ::TYPES[3] = uObject_typeof();
}
