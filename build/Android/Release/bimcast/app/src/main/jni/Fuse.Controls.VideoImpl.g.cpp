...
static void VideoVisual_build(uType* type)
{
    ...
    ::STRINGS[4] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Controls.Video\\0.35.12\\$.uno");
...
void VideoVisual__FuseControlsVideoImplIVideoCallbacksOnError_fn(VideoVisual* __this, ::g::Uno::Exception* e)
{
    ...
    ::g::Fuse::Diagnostics::UnknownException(::STRINGS[3/*"Video error"*/], e, __this, ::STRINGS[4/*"C:\\Program...*/], 1021, ::STRINGS[5/*"Fuse.Contro...*/]);
}
...
{
    ::g::Fuse::Diagnostics::Unsupported(::STRINGS[6/*"IPlayback.P...*/], __this, ::STRINGS[4/*"C:\\Program...*/], 1068, ::STRINGS[7/*"Fuse.Trigge...*/]);
}
