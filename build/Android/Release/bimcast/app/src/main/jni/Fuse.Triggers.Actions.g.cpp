...
// C:\ProgramData\Uno\Packages\Fuse.Elements\0.35.12\Triggers\Actions\$.uno
// ------------------------------------------------------------------------
...
{
    ::TYPES[8] = ::g::Fuse::Triggers::IPlayback_typeof();
    type->SetFields(9);
}
...
void Pause__Perform_fn(Pause* __this, ::g::Fuse::Node* target)
{
    ...
    uObject* t = (ind1 != NULL) ? ind1 : uAs<uObject*>(target, ::TYPES[8/*Fuse.Triggers.IPlayback*/]);

    if (t != NULL)
    {
        if (::g::Fuse::Triggers::IPlayback::CanPause(uInterface(uPtr(t), ::TYPES[8/*Fuse.Triggers.IPlayback*/])))
            ::g::Fuse::Triggers::IPlayback::Pause(uInterface(uPtr(t), ::TYPES[8/*Fuse.Triggers.IPlayback*/]));
    }
}
// }
...
void PlayTo__Perform_fn(PlayTo* __this, ::g::Fuse::Node* target)
{
    ...
    if (t != NULL)
    {
        if (::g::Fuse::Triggers::IPlayback::CanPlayTo(uInterface(uPtr(t), ::TYPES[8/*Fuse.Triggers.IPlayback*/])))
            ::g::Fuse::Triggers::IPlayback::PlayTo(uInterface(uPtr(t), ::TYPES[8/*Fuse.Triggers.IPlayback*/]), __this->Progress());
    }
}
...
{
    ::TYPES[9] = ::g::Fuse::Triggers::IPulseTrigger_typeof();
    type->SetFields(8,
...
void Pulse__Perform_fn(Pulse* __this, ::g::Fuse::Node* target)
{
    ...
    if (t != NULL)
        ::g::Fuse::Triggers::IPulseTrigger::Pulse(uInterface(uPtr(t), ::TYPES[9/*Fuse.Triggers.IPulseTrigger*/]));
}
...
static void RaiseUserEvent_build(uType* type)
{
    ...
    ::STRINGS[2] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.UserEvents\\0.35.12\\$.uno");
    ::STRINGS[3] = uString::Const("Perform");
    ::TYPES[10] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Triggers::Actions::UserEventArg_typeof());
    ::TYPES[11] = ::g::Uno::Collections::Dictionary_typeof()->MakeType(::g::Uno::String_typeof(), uObject_typeof());
    ::TYPES[12] = ::g::Uno::Collections::IEnumerable_typeof()->MakeType(::g::Fuse::Triggers::Actions::UserEventArg_typeof());
    ::TYPES[13] = ::g::Uno::Collections::IEnumerator_typeof();
    ::TYPES[14] = ::g::Uno::Collections::IEnumerator1_typeof()->MakeType(::g::Fuse::Triggers::Actions::UserEventArg_typeof());
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
    type->SetFields(8,
...
void RaiseUserEvent__Perform_fn(RaiseUserEvent* __this, ::g::Fuse::Node* target)
{
    ...
    if (__this->_event == NULL)
        ::g::Fuse::Diagnostics::UserError(::g::Uno::String::op_Addition2(::STRINGS[1/*"no UserEven...*/], ::g::Uno::UX::Selector__op_Implicit1(__this->EventName())), __this, ::STRINGS[2/*"C:\\Program...*/], 240, ::STRINGS[3/*"Perform"*/]);
    else
...
::g::Uno::Collections::Dictionary* RaiseUserEvent::ConvertArgs()
{
    ...
    if ((_args == NULL) || (::g::Uno::Collections::ICollection::Count(uInterface(uPtr(_args), ::TYPES[10/*Uno.Collections.ICollection<Fuse.Triggers.Actions.UserEventArg>*/])) == 0))
        return NULL;

    ::g::Uno::Collections::Dictionary* d = (::g::Uno::Collections::Dictionary*)::g::Uno::Collections::Dictionary::New1(::TYPES[11/*Uno.Collections.Dictionary<string, object>*/]);

    for (uObject* enum1 = (uObject*)::g::Uno::Collections::IEnumerable::GetEnumerator(uInterface(uPtr(_args), ::TYPES[12/*Uno.Collections.IEnumerable<Fuse.Triggers.Actions.UserEventArg>*/])); ::g::Uno::Collections::IEnumerator::MoveNext(uInterface(uPtr(enum1), ::TYPES[13/*Uno.Collections.IEnumerator*/])); )
    {
        ::g::Fuse::Triggers::Actions::UserEventArg* arg = (::g::Uno::Collections::IEnumerator1::get_Current_ex(uInterface(uPtr(enum1), ::TYPES[14/*Uno.Collections.IEnumerator<Fuse.Triggers.Actions.UserEventArg>*/]), &ret3), ret3);
...
{
    ::STRINGS[4] = uString::Const("Requires a Visual and Navigator parent");
    ::STRINGS[5] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Controls.Navigation\\0.35.12\\$.uno");
    ::STRINGS[3] = uString::Const("Perform");
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
    ::TYPES[15] = ::g::Fuse::Controls::Navigator_typeof();
    type->SetFields(8);
}
...
void ReleasePage__Perform_fn(ReleasePage* __this, ::g::Fuse::Node* n)
{
    ...
    ::g::Fuse::Controls::Navigator* nav = (n == NULL) ? uCast< ::g::Fuse::Controls::Navigator*>(NULL, ::TYPES[15/*Fuse.Controls.Navigator*/]) : uAs< ::g::Fuse::Controls::Navigator*>(uPtr(n)->Parent(), ::TYPES[15/*Fuse.Controls.Navigator*/]);

    if ((v == NULL) || (nav == NULL))
    {
        ::g::Fuse::Diagnostics::UserError(::STRINGS[4/*"Requires a ...*/], __this, ::STRINGS[5/*"C:\\Program...*/], 283, ::STRINGS[3/*"Perform"*/]);
        return;
    }
...
void Resume__Perform_fn(Resume* __this, ::g::Fuse::Node* target)
{
    ...
    if (t != NULL)
    {
        if (::g::Fuse::Triggers::IPlayback::CanResume(uInterface(uPtr(t), ::TYPES[8/*Fuse.Triggers.IPlayback*/])))
            ::g::Fuse::Triggers::IPlayback::Resume(uInterface(uPtr(t), ::TYPES[8/*Fuse.Triggers.IPlayback*/]));
    }
}
// }
...
{
    ::TYPES[16] = ::g::Fuse::Triggers::Actions::IShow_typeof();
    type->SetFields(8);
}
...
{
    if (uIs(target, ::TYPES[16/*Fuse.Triggers.Actions.IShow*/]))
        ::g::Fuse::Triggers::Actions::IShow::Show(uInterface(uPtr((uObject*)target), ::TYPES[16/*Fuse.Triggers.Actions.IShow*/]));
}
// }
...
void Stop__Perform_fn(Stop* __this, ::g::Fuse::Node* target)
{
    ...
    if (t != NULL)
    {
        if (::g::Fuse::Triggers::IPlayback::CanStop(uInterface(uPtr(t), ::TYPES[8/*Fuse.Triggers.IPlayback*/])))
            ::g::Fuse::Triggers::IPlayback::Stop(uInterface(uPtr(t), ::TYPES[8/*Fuse.Triggers.IPlayback*/]));
    }
}
// }
...
{
    ::TYPES[17] = ::g::Fuse::Triggers::Actions::IToggleable_typeof();
    type->SetFields(8,
...
void Toggle__Perform_fn(Toggle* __this, ::g::Fuse::Node* target)
{
    ...
    if (t != NULL)
        ::g::Fuse::Triggers::Actions::IToggleable::Toggle(uInterface(uPtr(t), ::TYPES[17/*Fuse.Triggers.Actions.IToggleable*/]));
}
...
uObject* Toggle::FindTarget(::g::Fuse::Node* n)
{
    while (n != NULL)
    {
        uObject* iv = uAs<uObject*>(n, ::TYPES[17/*Fuse.Triggers.Actions.IToggleable*/]);
...
{
    ::TYPES[1] = ::g::Fuse::Visual_typeof();
    ::TYPES[19] = ::g::Fuse::Visual_typeof()->MakeMethod(1, ::g::Fuse::Controls::WebView_typeof());
    type->SetFields(8);
}
...
void WebViewNavAction__Perform_fn(WebViewNavAction* __this, ::g::Fuse::Node* target)
{
    ...
    ::g::Fuse::Controls::WebView* webView = (::g::Fuse::Controls::WebView*)uPtr(v)->FindByType(::TYPES[19/*Fuse.Visual.FindByType<Fuse.Controls.WebView>*/]);
