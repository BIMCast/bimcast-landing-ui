...
void Builtins::ctor_(::g::Fuse::Scripting::Context* context)
{
    ...
    uPtr(context)->Evaluate(::STRINGS[0/*"es6-promise"*/], uPtr(::g::FuseReactive_bundle::es6promise4bde52e5())->ReadAllText());
    Observable = uCast< ::g::Fuse::Scripting::Function*>(::g::Fuse::Scripting::FileModule::New2(::g::Uno::UX::FileSource::op_Implicit(::g::FuseReactive_bundle::Observable8fa3ae58()))->EvaluateExports(context, ::STRINGS[1/*"FuseJS/Obse...*/]), ::TYPES[0/*Fuse.Scripting.Function*/]);
    uObject* res;
