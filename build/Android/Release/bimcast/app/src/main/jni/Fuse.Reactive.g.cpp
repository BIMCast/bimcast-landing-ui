...
void Console::Dir1(::g::Uno::Text::StringBuilder* builder, uObject* obj, int maxDepth, int indent)
{
    ...
    if (uIs(obj, ::TYPES[15/*Fuse.Scripting.Array*/]))
    {
        ...
        uPtr(builder)->AppendLine(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[12/*"Array["*/], uBox<int>(::TYPES[8/*int*/], uPtr(a)->Length())), ::STRINGS[13/*"]"*/]));
        ...
        if (indent <= maxDepth)
            ...
            {
                Console::Indent(builder, indent);
                uPtr(builder)->Append2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition1(::STRINGS[10/*""*/], uBox<int>(::TYPES[8/*int*/], i)), ::STRINGS[11/*": "*/]));
...
void Console::Init(::g::Fuse::Scripting::Context* c)
{
    ...
    uPtr(console)->Item(::STRINGS[15/*"log"*/], uDelegate::New(::TYPES[16/*Fuse.Scripting.Callback*/], (void*)Console__Log_fn));
    console->Item(::STRINGS[16/*"dir"*/], uDelegate::New(::TYPES[16/*Fuse.Scripting.Callback*/], (void*)Console__Dir_fn));
...
void DataBinding::TryPushAsMarshalledValue(uObject* newValue)
{
    ...
    if ((::g::Fuse::Scripting::Marshal__TryConvertTo1_fn(__types[1], newValue, &value, &ret3), ret3))
    {
        ...
        catch (const uThrowable& __t)
        {
            ...
            ::g::Fuse::Diagnostics::UserError(uPtr(e)->ToString(), Target(), ::STRINGS[4/*"C:\\Program...*/], 372, ::STRINGS[23/*"TryPushAsMa...*/]);
        }
    }
}
...
{
    uPtr(uPtr(c)->GlobalObject())->Item(::STRINGS[24/*"debug_log"*/], uDelegate::New(::TYPES[16/*Fuse.Scripting.Callback*/], (void*)DebugLog__Log_fn));
}
...
void Each__FuseScriptingIObserverOnRemoveAt_fn(Each* __this, int* index)
{
    ...
    {
        ::g::Fuse::Diagnostics::InternalError(::STRINGS[25/*"Removing an...*/], __this, ::STRINGS[4/*"C:\\Program...*/], 789, ::STRINGS[26/*"Fuse.Script...*/]);
        return;
    }
...
static void JavaScript_build(uType* type)
{
    ...
    ::STRINGS[31] = uString::Const("JavaScript error");
    ::STRINGS[32] = uString::Const("Cannot require() a rooted module");
    ::TYPES[25] = ::g::Uno::Action_typeof();
    ::TYPES[17] = ::g::Uno::IDisposable_typeof();
...
void JavaScript__FuseScriptingIModuleProviderGetModule_fn(JavaScript* __this, ::g::Fuse::Scripting::Module** __retval)
{
    if (__this->IsRootingCompleted())
        U_THROW(::g::Uno::Exception::New2(::STRINGS[32/*"Cannot requ...*/]));
...
void JavaScript::EvaluateModule()
{
...

    {
        ...
        if (newModuleResult->Error() == NULL)
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserSuccess(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[28/*"JavaScript ...*/], FileName()), ::STRINGS[29/*" fixed!"*/]), this, ::STRINGS[4/*"C:\\Program...*/], 1268, ::STRINGS[30/*"EvaluateMod...*/]);
        ...
        else
        {
            ...
            {
                ::g::Fuse::Diagnostics::UserScriptError(::STRINGS[31/*"JavaScript ...*/], se, this, ::STRINGS[4/*"C:\\Program...*/], 1279, ::STRINGS[30/*"EvaluateMod...*/]);
...
void RootableScriptModule__GenerateArgs_fn(RootableScriptModule* __this, ::g::Fuse::Scripting::Context* c, ::g::Fuse::Scripting::ModuleResult* result, ::g::Uno::Collections::List* args, uString** __retval)
{
    ...
    while (nt != NULL)
    {
        ...
        {
            argsString = ::g::Uno::String::op_Addition2(argsString, ::g::Uno::String::op_Addition2(::STRINGS[33/*", "*/], uPtr(uPtr(nt)->Entries)->Strong<uString*>(e)));
...
static void SegmentObserver_build(uType* type)
{
    ...
    ::STRINGS[35] = uString::Const("Cannot access disposed PathSubscription");
    ::STRINGS[36] = uString::Const("Data binding to '");
    ::STRINGS[37] = uString::Const("': expected single value, got array");
    ::STRINGS[38] = uString::Const("': expected single value, got array of length ");
    ::TYPES[17] = ::g::Uno::IDisposable_typeof();
    ::TYPES[18] = ::g::Fuse::Scripting::Observable_typeof();
    ::TYPES[29] = ::g::Fuse::Scripting::ObjectMirror_typeof();
    ::TYPES[25] = ::g::Uno::Action_typeof();
...
{
    if (_isDisposed)
        U_THROW(::g::Uno::Exception::New2(::STRINGS[35/*"Cannot acce...*/]));
...
void SegmentObserver::OnAdd(uObject* addedValue)
{
    ...
    U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[36/*"Data bindin...*/], _key), ::STRINGS[37/*"': expected...*/])));
}
...
void SegmentObserver::OnNewAll(::g::Fuse::Scripting::ListMirror* values)
{
    ...
    if (uPtr(values)->Length() > 0)
        U_THROW(::g::Uno::Exception::New2(::g::Uno::String::op_Addition1(::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(::STRINGS[36/*"Data bindin...*/], _key), ::STRINGS[38/*"': expected...*/]), uBox<int>(::TYPES[8/*int*/], uPtr(values)->Length()))));
}
...
uString* SegmentObserver::CombineKeyAndPath(uString* key, uString* path)
{
    if (::g::Uno::String::op_Inequality(path, NULL) && (uPtr(path)->Length() > 0))
        return ::g::Uno::String::op_Addition2(::g::Uno::String::op_Addition2(key, ::STRINGS[34/*"."*/]), path);
    else
        return key;
}
...
{
    ::STRINGS[39] = uString::Const("Skipped Exception");
    ::STRINGS[4] = uString::Const("C:\\ProgramData\\Uno\\Packages\\Fuse.Reactive\\0.35.12\\$.uno");
    ::STRINGS[40] = uString::Const("CheckAndThrow");
    ::STRINGS[41] = uString::Const("ThreadWorked failed");
    ::STRINGS[42] = uString::Const("Run");
    ::STRINGS[43] = uString::Const("Could not create script context");
...
void ThreadWorker::CheckAndThrow()
{
    ...
    {
        if (prev != NULL)
            ::g::Fuse::Diagnostics::UnknownException(::STRINGS[39/*"Skipped Exc...*/], next, this, ::STRINGS[4/*"C:\\Program...*/], 1954, ::STRINGS[40/*"CheckAndThrow"*/]);
...
void ThreadWorker::Run()
{
    ...
    {
        ::g::Uno::Exception* e = __t.Exception;
        ::g::Fuse::Diagnostics::UnknownException(::STRINGS[41/*"ThreadWorke...*/], e, this, ::STRINGS[4/*"C:\\Program...*/], 1846, ::STRINGS[42/*"Run"*/]);
...
void ThreadWorker::RunInner()
{
...

    {
        ...
        if (ThreadWorker::_context_ == NULL)
        {
            ...
            if (ThreadWorker::_context_ == NULL)
                U_THROW(::g::Uno::Exception::New2(::STRINGS[43/*"Could not c...*/]));
