...
public class TextEditRenderer
{
    ...
    public static void CopyState120(final Object container,final Object sourceHandle,final Object targetHandle)
    {
    ...
    public static Object CreateContainer121()
    {
        android.widget.GridLayout gridLayout = new android.widget.GridLayout(com.apps.bimcast.bimcast.GetRootActivity());
    ...
    public static Object CreateTextEdit122()
    {
        android.widget.TextView tv = new android.widget.TextView(com.apps.bimcast.bimcast.GetRootActivity());
