...
: base(new [] {new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("127.0.0.1"), 12124), new Uno.Net.IPEndPoint(Uno.Net.IPAddress.Parse("172.20.10.2"), 12124)}, "C:\\Users\\ManailMJ\\Documents\\Dev\\fuse\\projects\\working-versions\\bimcast-landing-ui\\bimcast-landing-ui.unoproj", GetBundle, new string[] { })
{
...
{
return Uno.IO.Bundle.Get("bimcast-landing-ui");
}
}
}
